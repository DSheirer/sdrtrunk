...
public class IMBEAudioFormat
{
	...
	public static final float PCM_8KHZ_SAMPLE_RATE = 8000;
	public static final float PCM_48KHZ_SAMPLE_RATE = 48000;
	public static final float PCM_FRAME_RATE = 8000;
