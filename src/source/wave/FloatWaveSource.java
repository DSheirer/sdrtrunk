...
public class FloatWaveSource extends WaveSource
{
    ...
    public void open() throws IOException
    {
        ...
        if( mBytesPerFrame != 2 || mInputStream.getFormat().getChannels() != 1 )
        {
        	throw new IOException( "Unsupported Wave Format - requires mono "
        			+ "channel with 16-bit samples" );
        }
    ...
    private boolean next( boolean broadcast ) throws IOException
    {
    	...
    	{
    		short sample = mBufferWrapper.get();
