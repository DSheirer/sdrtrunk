...
public class MINNode extends AliasIDNode
{
    private static final long serialVersionUID = 1L;

    public MINNode( PlaylistManager playlistManager, Min min )
	{
        super( playlistManager, min );
 	}
    ...
    public Min getMIN()
    {
    	return (Min)getUserObject();
    }
    
    public String toString()
    {
    	return "MIN " + getMIN().getMin();
    }
		...
		addSystemItem.addActionListener( new ActionListener() 
		{
            ...
            public void actionPerformed( ActionEvent e )
            {
				...
				if( n == JOptionPane.YES_OPTION )
				{
					...
					parent.getAlias().removeAliasID( getMIN() );

					save();

					getModel().removeNodeFromParent( MINNode.this );
				}
            }
		} );
