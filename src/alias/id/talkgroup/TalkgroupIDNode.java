...
public class TalkgroupIDNode extends AliasIDNode
{
    private static final long serialVersionUID = 1L;
    
    public TalkgroupIDNode( PlaylistManager playlistManager, TalkgroupID id )
	{
    ...
    {
        return new TalkgroupIDEditor( this );
    }
    
    public TalkgroupID getTalkgroupID()
    {
    	return (TalkgroupID)getUserObject();
    }
    
    public String toString()
    {
    	return "Talkgroup " + getTalkgroupID().getTalkgroup();
    }
		...
		addSystemItem.addActionListener( new ActionListener() 
		{
            ...
            public void actionPerformed( ActionEvent e )
            {
				...
				if( n == JOptionPane.YES_OPTION )
				{
					...
					parent.getAlias().removeAliasID( getTalkgroupID() );

					save();

					getModel().removeNodeFromParent( TalkgroupIDNode.this );
				}
            }
		} );
