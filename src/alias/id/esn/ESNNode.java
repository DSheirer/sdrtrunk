...
public class ESNNode extends AliasIDNode
{
    ...
    public Esn getESN()
    {
    	return (Esn)getUserObject();
    }
    
    public String toString()
    {
    	return "ESN " + getESN().getEsn();
    }
		...
		addSystemItem.addActionListener( new ActionListener() 
		{
            ...
            public void actionPerformed( ActionEvent e )
            {
				...
				if( n == JOptionPane.YES_OPTION )
				{
					...
					parent.getAlias().removeAliasID( getESN() );

					save();

					getModel().removeNodeFromParent( ESNNode.this );
				}
            }
		} );
