...
public class ClipActionNode extends AliasActionNode
{
    ...
    {
        return (ClipAction)getUserObject();
    }

    public String toString()
    {
    	return "Action: Audio Clip";
    }
		...
		deleteItem.addActionListener( new ActionListener() 
		{
            ...
            public void actionPerformed( ActionEvent e )
            {
				...
				if( n == JOptionPane.YES_OPTION )
				{
					...
					parent.getAlias().removeAliasAction( getClipAction() );

					/* Save before removing the node ... so that we still have
					 * a reference to the parent's resources */
					save();

					getModel().removeNodeFromParent( ClipActionNode.this );
				}
            }
		} );
