...
public class ScriptActionNode extends AliasActionNode
{
    ...
    {
        return (ScriptAction)getUserObject();
    }
		...
		deleteItem.addActionListener( new ActionListener() 
		{
            ...
            public void actionPerformed( ActionEvent e )
            {
				...
				if( n == JOptionPane.YES_OPTION )
				{
					...
					parent.getAlias().removeAliasAction( getScriptAction() );

					/* Save before removing the node ... so that we still have
					 * a reference to the parent's resources */
					save();

					getModel().removeNodeFromParent( ScriptActionNode.this );
				}
            }
		} );
