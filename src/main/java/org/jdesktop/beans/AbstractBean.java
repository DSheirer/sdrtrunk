 ...
 * patterns to allow visual manipulation of the bean's ua.in.smartjava.properties and event
...
public abstract class AbstractBean {
     ...
     * The listener is registered for all ua.in.smartjava.properties.
     ...
     * for all ua.in.smartjava.properties.
     * If <code>listener</code> was added more than once to the same event
     * ua.in.smartjava.source, it will be notified one less time after being removed.
     ...
     * If <code>listener</code> was added more than once to the same event
     * ua.in.smartjava.source for the specified property, it will be notified one less time
     * after being removed.
     ...
     * those registered on all ua.in.smartjava.properties.  If <code>propertyName</code>
     * is null, only check for listeners registered on all ua.in.smartjava.properties.
     *
