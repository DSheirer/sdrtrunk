...
import io.github.dsheirer.buffer.hydrasdr.HydraSdrBufferIteratorScalar;
import io.github.dsheirer.buffer.hydrasdr.HydraSdrBufferIteratorVector128Bits;
import io.github.dsheirer.buffer.hydrasdr.HydraSdrBufferIteratorVector256Bits;
import io.github.dsheirer.buffer.hydrasdr.HydraSdrBufferIteratorVector512Bits;
import io.github.dsheirer.buffer.hydrasdr.HydraSdrBufferIteratorVector64Bits;
...
/**
 * Calculates optimal implementation (SCALAR vs VECTOR) for non-interleaved HydraSDR native buffers.
 */
public class HydraSdrUnpackedCalibration extends Calibration
{
     ...
     */
    public HydraSdrUnpackedCalibration()
    {
        super(CalibrationType.HYDRASDR_UNPACKED_ITERATOR);
    }
    ...
    public void calibrate() throws CalibrationException
    {
        ...
        mLog.info("HYDRASDR UNPACKED - VECTOR SIMD LANES PREFERRED: " + FloatVector.SPECIES_PREFERRED.length());
        ...
        mLog.info("HYDRASDR UNPACKED WARMUP - SCALAR: " + DECIMAL_FORMAT.format(scalarMean.getResult()));
        ...
        switch(FloatVector.SPECIES_PREFERRED.length())
        {
            ...
            case 16:
            {
                ...
                mLog.info("HYDRASDR UNPACKED WARMUP - VECTOR 512: " + DECIMAL_FORMAT.format(vector512Mean.getResult()));
            }
            case 8:
            {
                ...
                mLog.info("HYDRASDR UNPACKED WARMUP - VECTOR 256: " + DECIMAL_FORMAT.format(vector256Mean.getResult()));
            }
            case 4:
            {
                ...
                mLog.info("HYDRASDR UNPACKED WARMUP - VECTOR 128: " + DECIMAL_FORMAT.format(vector128Mean.getResult()));
            }
            case 2:
            {
                ...
                mLog.info("HYDRASDR UNPACKED WARMUP - VECTOR 64: " + DECIMAL_FORMAT.format(vector64Mean.getResult()));
            }
        }
        ...
        mLog.info("HYDRASDR UNPACKED - SCALAR: " + DECIMAL_FORMAT.format(scalarMean.getResult()));
        ...
        switch(FloatVector.SPECIES_PREFERRED.length())
        {
            ...
            case 16:
            {
                ...
                mLog.info("HYDRASDR UNPACKED - VECTOR 512: " + DECIMAL_FORMAT.format(vector512Mean.getResult()));
            ...
            case 8:
            {
                ...
                mLog.info("HYDRASDR UNPACKED - VECTOR 256: " + DECIMAL_FORMAT.format(vector256Mean.getResult()));
            ...
            case 4:
            {
                ...
                mLog.info("HYDRASDR UNPACKED - VECTOR 128: " + DECIMAL_FORMAT.format(vector128Mean.getResult()));
            ...
            case 2:
            {
                ...
                mLog.info("HYDRASDR UNPACKED - VECTOR 64: " + DECIMAL_FORMAT.format(vector64Mean.getResult()));
        ...
        mLog.info("HYDRASDR UNPACKED - SET OPTIMAL IMPLEMENTATION TO: " + getImplementation());
    }
    ...
    private long testScalar(short[] samples, short[] residualI, short[] residualQ)
    {
        ...
        {
            HydraSdrBufferIteratorScalar iterator = new HydraSdrBufferIteratorScalar(samples, residualI,
    ...
    private long testVector64(short[] samples, short[] residualI, short[] residualQ)
    {
        ...
        while((System.currentTimeMillis() - start) < ITERATION_DURATION_MS)
        {
            HydraSdrBufferIteratorVector64Bits iterator = new HydraSdrBufferIteratorVector64Bits(samples, residualI,
                    residualQ, 0.0f, System.currentTimeMillis(), 0.0f);
    ...
    private long testVector128(short[] samples, short[] residualI, short[] residualQ)
    {
        ...
        while((System.currentTimeMillis() - start) < ITERATION_DURATION_MS)
        {
            HydraSdrBufferIteratorVector128Bits iterator = new HydraSdrBufferIteratorVector128Bits(samples, residualI,
                    residualQ, 0.0f, System.currentTimeMillis(), 0.0f);
    ...
    private long testVector256(short[] samples, short[] residualI, short[] residualQ)
    {
        ...
        while((System.currentTimeMillis() - start) < ITERATION_DURATION_MS)
        {
            HydraSdrBufferIteratorVector256Bits iterator =
                    new HydraSdrBufferIteratorVector256Bits(samples, residualI, residualQ, 0.0f,
    ...
    private long testVector512(short[] samples, short[] residualI, short[] residualQ)
    {
        ...
        while((System.currentTimeMillis() - start) < ITERATION_DURATION_MS)
        {
            HydraSdrBufferIteratorVector512Bits iterator =
                    new HydraSdrBufferIteratorVector512Bits(samples, residualI, residualQ, 0.0f,
                            System.currentTimeMillis(), 0.0f);
