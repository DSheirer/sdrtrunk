...
/**
 * Vector SIMD implementation for non-packed HydraSDR native buffers
 */
public class HydraSdrInterleavedBufferIteratorVector256Bits extends HydraSdrBufferIterator<InterleavedComplexSamples>
{
     ...
     *
     * @param samples from the HydraSDR, either packed or unpacked.
     ...
     */
    public HydraSdrInterleavedBufferIteratorVector256Bits(short[] samples, short[] residualI, short[] residualQ, float averageDc,
