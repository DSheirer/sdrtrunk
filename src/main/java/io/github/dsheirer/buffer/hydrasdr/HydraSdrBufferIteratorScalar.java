...
/**
 * Scalar implementation for non-packed HydraSDR native buffers
 */
public class HydraSdrBufferIteratorScalar extends HydraSdrBufferIterator<ComplexSamples>
{
    /**
     ...
     */
    public HydraSdrBufferIteratorScalar(short[] samples, short[] residualI, short[] residualQ, float averageDc, long timestamp, float samplesPerMillisecond)
    {
