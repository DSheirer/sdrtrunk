 ...
 */
public class SampleBufferIteratorVector128Bits extends SampleBufferIterator<ComplexSamples>
{
     ...
     */
    public SampleBufferIteratorVector128Bits(short[] samples, short[] residualI, short[] residualQ, float averageDc,
