...
import io.github.dsheirer.instrument.gui.viewer.chart.SampleBufferChart;
...
public class LTRNetPane extends RealDecoderPane
{
    ...
    private SampleBufferChart mSampleBufferChart;
    ...
    private SampleBufferChart getSampleBufferChart()
    {
        if(mSampleBufferChart == null)
        {
            mSampleBufferChart = new SampleBufferChart(getDecoder(), 106);
        }
