...
public abstract class FullyQualifiedTalkgroupIdentifier extends TalkgroupIdentifier
{
     ...
     * @param persona used on the local system as an alias to the fully qualified talkgroup.
     ...
     */
    public FullyQualifiedTalkgroupIdentifier(int persona, int wacn, int system, int id, Role role)
    {
