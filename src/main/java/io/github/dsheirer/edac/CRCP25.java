...
//        System.out.println("FACCH MAC PDU CRC-12" +
//                " CHECKSUM:" + Long.toHexString(checksum).toUpperCase() +
//                " CALCULATED:" + Long.toHexString(calculated).toUpperCase() +
//                " RESIDUAL:" + Long.toHexString(residual).toUpperCase() +
//                ((checksum == calculated) ? " PASS" : " **FAIL**"));
...
//        System.out.println("SACCH MAC PDU CRC-12" +
//                " CHECKSUM:" + Long.toHexString(checksum).toUpperCase() +
//                " CALCULATED:" + Long.toHexString(calculated).toUpperCase() +
//                " RESIDUAL:" + Long.toHexString(residual).toUpperCase() +
//                ((checksum == calculated) ? " PASS" : " **FAIL**"));
...
//        System.out.println("LCCH MAC PDU CRC-16" +
//                " CHECKSUM:" + Long.toHexString(checksum).toUpperCase() +
//                " CALCULATED:" + Long.toHexString(calculated).toUpperCase() +
//                " RESIDUAL:" + Long.toHexString(residual).toUpperCase() +
//                ((checksum == calculated) ? " PASS" : " **FAIL**"));
