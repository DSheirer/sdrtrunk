...
public class Binary40_9_16
{
    ...
    public Binary40_9_16()
    {
        ...
        for(Long key: keys)
        {
            ...
            System.out.println("Channel 1 Key: " + String.format("%10X", key) + " " + key + "\tCodeword: " + message + " Value:" + message.toHexString() + " Distance:" + distance);
        }
        ...
        for(Long key: keys2)
        {
            ...
            int distance = getDistance(key, keys);
            System.out.println("Channel 2 Key: " + String.format("%10X", key) + " " + key + "\tCodeword: " + message + " Value:" + message.toHexString() + " Distance:" + distance);
        }
    }
