...
import io.github.dsheirer.gui.power.ChannelSpectrumSquelchPanel;
...
public class NowPlayingPanel extends JPanel
{
    ...
    private final ChannelSpectrumSquelchPanel mChannelSpectrumSquelchPanel;
                           ...
                           SettingsManager settingsManager, boolean detailTabsVisible)
    {
        ...
        mChannelSpectrumSquelchPanel = new ChannelSpectrumSquelchPanel(playlistManager, settingsManager);
