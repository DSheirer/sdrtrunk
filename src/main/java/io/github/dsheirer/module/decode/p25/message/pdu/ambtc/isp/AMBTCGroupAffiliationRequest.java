...
public class AMBTCGroupAffiliationRequest extends AMBTCMessage
{
    ...
    public AMBTCGroupAffiliationRequest(PacketSequence packetSequence, int nac, long timestamp)
    {
    ...
    public IIdentifier getGroupId()
    {
        if(mGroupId == null)
        {
            mGroupId = APCO25ToTalkgroup.createGroup(getHeader().getMessage().getInt(BLOCK_0_GROUP_ID));
        }
