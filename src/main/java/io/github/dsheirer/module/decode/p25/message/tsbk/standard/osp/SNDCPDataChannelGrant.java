 ...
 */
public class SNDCPDataChannelGrant extends OSPMessage implements FrequencyBandReceiver
{
     ...
     */
    public SNDCPDataChannelGrant(DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
