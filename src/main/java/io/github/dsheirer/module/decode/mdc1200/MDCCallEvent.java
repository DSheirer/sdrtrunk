...
{
    public MDCCallEvent(CallEventType callEventType, AliasList aliasList, String fromID, String toID, String details)
    {
        super(DecoderType.MDC1200, callEventType, aliasList, fromID, toID, details);
    }
    ...
    getMDCCallEvent(MDCMessage message)
    {
        ...
        return new MDCCallEvent.Builder(type).details(sbDetails.toString()).from(message.getFromID()).build();
    }
}
