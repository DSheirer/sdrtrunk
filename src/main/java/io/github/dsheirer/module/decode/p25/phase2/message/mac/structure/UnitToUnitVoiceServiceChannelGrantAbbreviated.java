                    ...
                    implements IFrequencyBandReceiver, IP25ChannelGrantDetailProvider, IServiceOptionsProvider
{
     ...
     */
    public UnitToUnitVoiceServiceChannelGrantAbbreviated(CorrectedBinaryMessage message, int offset)
    {
    ...
    /**
     * Implements the channel grant detail provider but always returns an empty service options.
     */
    ...
    public APCO25Channel getChannel()
    {
        if(mChannel == null)
        {
            mChannel = new APCO25Channel(new P25P2Channel(getInt(FREQUENCY_BAND), getInt(CHANNEL_NUMBER)));
        }
