...
/**
 * Unit-to-Unit voice channel grant - extended format
 */
public class UnitToUnitVoiceChannelGrantExtended extends MacStructure implements IFrequencyBandReceiver
{
     ...
     */
    public UnitToUnitVoiceChannelGrantExtended(CorrectedBinaryMessage message, int offset)
    {
