 ...
 */
public interface IP25P1DataUnitDetectListener
{
    /**
     ...
     */
    void dataUnitDetected(P25P1DataUnitID dataUnitID, int nac, int bitErrors, int discardedDibits, int[] correctedNid);
