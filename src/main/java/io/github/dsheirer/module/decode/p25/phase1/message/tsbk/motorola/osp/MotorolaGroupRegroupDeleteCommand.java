 ...
 */
public class MotorolaGroupRegroupDeleteCommand extends VendorOSPMessage
{
     ...
     * @param dataUnitID for the TSBK
     * @param message with fields
     * @param nac code
     * @param timestamp for this message
     */
    public MotorolaGroupRegroupDeleteCommand(P25P1DataUnitID dataUnitID, CorrectedBinaryMessage message, int nac,
                                             long timestamp)
    {
