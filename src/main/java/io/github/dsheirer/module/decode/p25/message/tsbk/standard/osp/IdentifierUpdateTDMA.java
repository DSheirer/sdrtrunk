 ...
 */
public class IdentifierUpdateTDMA extends OSPMessage implements IFrequencyBand
{
     ...
     */
    public IdentifierUpdateTDMA(DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
