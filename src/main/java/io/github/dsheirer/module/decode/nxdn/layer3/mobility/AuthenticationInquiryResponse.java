...
/**
 * Authentication inquiry response
 */
public class AuthenticationInquiryResponse extends Authentication
{
    ...
    public String toString()
    {
        ...
        sb.append("AUTHENTICATION RESPONSE FROM:").append(getSource());
    ...
    {
        return getMessage().getSubMessage(OCTET_6, OCTET_13).toHexString();
    }
