...
import io.github.dsheirer.module.decode.p25.message.tsbk.motorola.osp.PatchGroupAdd;
import io.github.dsheirer.module.decode.p25.message.tsbk.motorola.osp.PatchGroupDelete;
...
import io.github.dsheirer.module.decode.p25.message.tsbk.motorola.osp.PlannedChannelShutdown;
import io.github.dsheirer.module.decode.p25.message.tsbk.motorola.osp.UnknownMotorolaOSPMessage;
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.isp.AuthenticationQuery;
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.isp.CallAlertRequest;
...
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.isp.ProtectionParameterRequest;
...
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.isp.TelephoneInterconnectPstnRequest;
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.isp.UnitAcknowledgeResponse;
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.isp.UnitDeRegistrationRequest;
...
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.isp.UnknownISPMessage;
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.osp.AcknowledgeResponse;
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.osp.AdjacentStatusBroadcast;
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.osp.AuthenticationCommand;
...
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.osp.GroupDataChannelAnnouncementExplicit;
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.osp.GroupDataChannelGrant;
...
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.osp.ProtectionParameterUpdate;
...
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.osp.RadioUnitMonitorCommand;
...
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.osp.SNDCPDataPageRequest;
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.osp.SecondaryControlChannelBroadcast;
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.osp.StatusQuery;
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.osp.StatusUpdate;
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.osp.SyncBroadcast;
...
import io.github.dsheirer.module.decode.p25.message.tsbk.standard.osp.UnitDeRegistrationAcknowledge;
...
public class TSBKMessageFactory
{
    ...
    public static TSBKMessage create(Direction direction, DataUnitID dataUnitID,
