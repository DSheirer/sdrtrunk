...
/**
 * Status query extended LCCH
 */
public class StatusQueryExtendedLCCH extends MacStructureMultiFragment
{
     ...
     */
    public StatusQueryExtendedLCCH(CorrectedBinaryMessage message, int offset)
    {
