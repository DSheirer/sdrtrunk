 ...
 */
public class ExtendedFunctionCommandExtendedLCCH extends MacStructure
{
     ...
     */
    public ExtendedFunctionCommandExtendedLCCH(CorrectedBinaryMessage message, int offset)
    {
