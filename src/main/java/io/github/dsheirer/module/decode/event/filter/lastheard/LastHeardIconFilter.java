...
public class LastHeardIconFilter extends Filter<IDecodeEvent>
{
    private AliasModel mAliasModel;
    private Map<String, FilterElement<String>> mElements = new HashMap<>();

    public LastHeardIconFilter(String name, AliasModel aliasModel, IconModel iconModel)
    {
        super(name);
    ...
    public Optional<FilterElement<String>> matchAliasToFilter(IDecodeEvent iDecodeEvent)
    {
        ...
        List<Identifier> identifiers = identifierCollection.getIdentifiers(Role.TO);
        if (iDecodeEvent.getDuration() > 0 && identifiers != null && !identifiers.isEmpty())
        {
