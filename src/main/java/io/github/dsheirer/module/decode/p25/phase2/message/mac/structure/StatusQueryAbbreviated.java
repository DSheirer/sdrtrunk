...
/**
 * Status query - abbreviated format
 */
public class StatusQueryAbbreviated extends MacStructure
{
     ...
     */
    public StatusQueryAbbreviated(CorrectedBinaryMessage message, int offset)
    {
