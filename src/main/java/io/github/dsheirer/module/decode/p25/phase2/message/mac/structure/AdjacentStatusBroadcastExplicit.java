...
/**
 * Adjacent (neighbor site) status broadcast explicit
 */
public class AdjacentStatusBroadcastExplicit extends MacStructure implements IFrequencyBandReceiver
{
     ...
     */
    public AdjacentStatusBroadcastExplicit(CorrectedBinaryMessage message, int offset)
    {
