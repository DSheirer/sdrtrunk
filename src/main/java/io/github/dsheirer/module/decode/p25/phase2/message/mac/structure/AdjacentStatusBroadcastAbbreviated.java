 ...
 */
public class AdjacentStatusBroadcastAbbreviated extends MacStructure implements IFrequencyBandReceiver
{
     ...
     */
    public AdjacentStatusBroadcastAbbreviated(CorrectedBinaryMessage message, int offset)
    {
