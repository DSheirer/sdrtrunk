...
public class RemoteControlResponseWithESN extends NXDNLayer3Message
{
     ...
     */
    public RemoteControlResponseWithESN(CorrectedBinaryMessage message, long timestamp, NXDNMessageType type)
    {
    ...
    public NXDNRadioIdentifier getSource()
    {
        ...
        {
            if(getCallControlOption().hasLocationId() && getLocationIDOption().isSource())
            {
