 ...
 */
public class squelchDecoder extends SquelchControlDecoder implements ISourceEventListener, IComplexSamplesListener,
        Listener<ComplexSamples>, IRealBufferProvider, IDecoderStateEventProvider, INoiseSquelchController
{
    private final static Logger mLog = LoggerFactory.getLogger(squelchDecoder.class);
     ...
     */
    public squelchDecoder(DecodeConfigNBFM config)
    {
        super(config);
    ...
    private void createCTCSSDetector()
    {
        ...
        mCTCSSDetector.setListener(new CTCSSDetector.CTCSSDetectorListener()
        {
            ...
            {
                squelchDecoder.this.ctcssDetected(code);
            }
    ...
    private void createDCSDetector(float sampleRate)
    {
        ...
        mDCSDetector.setListener(new DCSDetector.DCSDetectorListener()
        {
            ...
            {
                squelchDecoder.this.dcsDetected(code);
            }
    ...
    private void setSampleRate(double sampleRate)
    {
        ...
        mResampler.setListener(squelchDecoder.this::processResampledAudio);
