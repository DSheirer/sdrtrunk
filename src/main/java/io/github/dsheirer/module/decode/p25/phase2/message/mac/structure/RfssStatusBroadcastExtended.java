...
/**
 * RFSS status broadcast - extended format
 */
public class RfssStatusBroadcastExtended extends MacStructure implements IFrequencyBandReceiver
{
     ...
     */
    public RfssStatusBroadcastExtended(CorrectedBinaryMessage message, int offset)
    {
    ...
    public APCO25Channel getChannel()
    {
        if(mChannel == null)
        {
            ...
            P25P2ExplicitChannel channel = new P25P2ExplicitChannel(getMessage().getInt(TRANSMIT_FREQUENCY_BAND, getOffset()),
