 ...
 */
public class GroupVoiceChannelUpdateExplicit extends LinkControlWord implements FrequencyBandReceiver
{
     ...
     */
    public GroupVoiceChannelUpdateExplicit(BinaryMessage message)
    {
        super(message);
    }
