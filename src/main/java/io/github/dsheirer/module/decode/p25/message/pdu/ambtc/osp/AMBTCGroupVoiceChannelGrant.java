...
public class AMBTCGroupVoiceChannelGrant extends AMBTCMessage implements FrequencyBandReceiver
{
    ...
    public AMBTCGroupVoiceChannelGrant(PacketSequence packetSequence, int nac, long timestamp)
    {
