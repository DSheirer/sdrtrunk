 ...
 */
public class GroupDataServiceRequest extends ISPMessage
{
     ...
     */
    public GroupDataServiceRequest(DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
