...
public class IdentifierUpdateNonVUHFFrequency extends IdentifierUpdateFrequency
{
    ...
    public IdentifierUpdateNonVUHFFrequency(BinaryMessage message, DataUnitID duid, AliasList aliasList)
    {
