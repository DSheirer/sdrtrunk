...
public class IndividualPagingMessage extends MacStructure
{
    ...
    public TalkgroupIdentifier getTargetAddress1()
    {
        ...
        {
            mTargetAddress1 = APCO25ToTalkgroup.createIndividual(getMessage().getInt(TARGET_ADDRESS_1, getOffset()));
        }
    ...
    public TalkgroupIdentifier getTargetAddress2()
    {
        ...
        {
            mTargetAddress2 = APCO25ToTalkgroup.createIndividual(getMessage().getInt(TARGET_ADDRESS_2, getOffset()));
        }
    ...
    public TalkgroupIdentifier getTargetAddress3()
    {
        ...
        {
            mTargetAddress3 = APCO25ToTalkgroup.createIndividual(getMessage().getInt(TARGET_ADDRESS_3, getOffset()));
        }
    ...
    public TalkgroupIdentifier getTargetAddress4()
    {
        ...
        {
            mTargetAddress4 = APCO25ToTalkgroup.createIndividual(getMessage().getInt(TARGET_ADDRESS_4, getOffset()));
        }
