...
public class ProtectionParameterUpdate extends OSPMessage
{
     ...
     */
    public ProtectionParameterUpdate(DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
    ...
    public IIdentifier getEncryptionKey()
    {
        if(mEncryptionKey == null)
        {
            ...
            mEncryptionKey = APCO25EncryptionKey.create(algorithm, key);
        }
