...
public class AMBTCGroupDataChannelGrant extends AMBTCMessage implements FrequencyBandReceiver
{
    ...
    public AMBTCGroupDataChannelGrant(PacketSequence packetSequence, int nac, long timestamp)
    {
