 ...
 */
public class IdentifierUpdateVUHF extends OSPMessage implements IFrequencyBand
{
     ...
     */
    public IdentifierUpdateVUHF(DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
