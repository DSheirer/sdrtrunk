...
public class UMBTCMessageFilter extends Filter<IMessage>
{
    public UMBTCMessageFilter()
    {
        super("Unconfirmed Multi-Block Trunking Control");
    }
    ...
    {
        return message instanceof UMBTCMessage;
    }
