 ...
 */
public class GroupVoiceChannelGrant extends OSPMessage implements FrequencyBandReceiver
{
     ...
     */
    public GroupVoiceChannelGrant(DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
