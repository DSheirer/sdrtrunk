...
/**
 * Unit-to-unit voice channel grant - abbreviated format
 */
public class UnitToUnitVoiceChannelGrantAbbreviated extends MacStructure implements IFrequencyBandReceiver
{
     ...
     */
    public UnitToUnitVoiceChannelGrantAbbreviated(CorrectedBinaryMessage message, int offset)
    {
