        ...
        implements IFrequencyBandReceiver, IP25ChannelGrantDetailProvider, IServiceOptionsProvider
{
    ...
    private static final IntField TRANSMIT_CHANNEL_NUMBER = IntField.length12(OCTET_5_BIT_32 + 4);
    private static final IntField RECEIVE_FREQUENCY_BAND = IntField.length4(OCTET_7_BIT_48);
    private static final IntField RECEIVE_CHANNEL_NUMBER = IntField.length12(OCTET_7_BIT_48 + 4);
    private static final IntField SUPERGROUP_ADDRESS = IntField.length16(OCTET_9_BIT_64);
     ...
     */
    public MotorolaGroupRegroupChannelGrantExplicit(CorrectedBinaryMessage message, int offset)
    {
