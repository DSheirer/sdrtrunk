...
/**
 * Message update extended LCCH
 */
public class MessageUpdateExtendedLCCH extends MacStructureMultiFragment
{
    private static final IntField MESSAGE = IntField.length16(OCTET_4_BIT_24);
     ...
     */
    public MessageUpdateExtendedLCCH(CorrectedBinaryMessage message, int offset)
    {
