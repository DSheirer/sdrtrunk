 ...
 */
public class VoiceCallConnectionResponse extends VoiceCallWithOptionalLocation
{
     ...
     * @param lich info
     */
    public VoiceCallConnectionResponse(CorrectedBinaryMessage message, long timestamp, NXDNMessageType type, int ran, LICH lich)
    {
    ...
    public String toString()
    {
        ...
        {
            sb.append(getCallType()).append(" VOICE CALL CONNECTION ACCEPTED");
        }
        else
        {
            sb.append(getCallType()).append(" VOICE CALL CONNECTION FAIL:").append(cause);
