...
public class UserDeRegistrationAcknowledge extends ARSHeader
{
    /**
     ...
     */
    public UserDeRegistrationAcknowledge(BinaryMessage message, int offset)
    {
    ...
    public String toString()
    {
        ...
        sb.append("ARS USER DE-REGISTRATION ACKNOWLEDGED");
        return sb.toString();
    }
}
