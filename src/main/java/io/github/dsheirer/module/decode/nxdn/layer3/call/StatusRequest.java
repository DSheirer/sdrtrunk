 ...
 */
public class StatusRequest extends StatusCall
{
     ...
     * @param lich info
     */
    public StatusRequest(CorrectedBinaryMessage message, long timestamp, NXDNMessageType type, int ran, LICH lich)
    {
