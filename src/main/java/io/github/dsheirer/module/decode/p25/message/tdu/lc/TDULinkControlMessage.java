...
public class TDULinkControlMessage extends P25Message
{
    ...
    public static final ReedSolomon_63_47_17 mReedSolomonDecoder = new ReedSolomon_63_47_17(6);

    public TDULinkControlMessage(BinaryMessage message, DataUnitID duid, AliasList aliasList)
    {
