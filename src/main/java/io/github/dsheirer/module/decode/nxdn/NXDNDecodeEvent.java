 ...
 * NXDN Decode Event
 */
public class NXDNDecodeEvent extends DecodeEvent
{
    /**
     * Constructs a decode event
     * @param decodeEventType for the event
     * @param start timestamp
     */
    public NXDNDecodeEvent(DecodeEventType decodeEventType, long start)
    {
        super(decodeEventType, start);
        setProtocol(Protocol.NXDN);
    }
    ...
    public static DecodeEventBuilder builder(DecodeEventType decodeEventType, long timeStart)
    {
        ...
        decodeEventBuilder.protocol(Protocol.NXDN);
        decodeEventBuilder.timeslot(0);
