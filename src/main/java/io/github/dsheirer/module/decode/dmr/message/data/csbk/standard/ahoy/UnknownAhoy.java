...
/**
 * DMR Tier III Ahoy - Unknown Ahoy Type
 */
public class UnknownAhoy extends Ahoy
{
     ...
     * @param timeslot
     */
    public UnknownAhoy(DMRSyncPattern syncPattern, CorrectedBinaryMessage message, CACH cach, SlotType slotType, long timestamp, int timeslot)
    {
    ...
    public String toString()
    {
        ...
        sb.append(" AHOY ").append(getServiceKind());
