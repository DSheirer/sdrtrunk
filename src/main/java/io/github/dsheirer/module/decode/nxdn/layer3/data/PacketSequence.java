...
public class PacketSequence extends NXDNMessage
{
     ...
     */
    public PacketSequence(CorrectedBinaryMessage message, IPacketHeader header, EncryptionKeyIdentifier encryption, String iv)
    {
        ...
        //The packet sequence assembler sets the message payload corrected bit count to -1 when it fails CRC-32
        setValid(message.getCorrectedBitCount() >= 0);
    }
