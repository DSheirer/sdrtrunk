 ...
 */
public class NXDNMessageAssembler implements Listener<Dibit>
{
    private static final Logger LOGGER = LoggerFactory.getLogger(NXDNMessageAssembler.class);
     ...
     */
    public NXDNMessageAssembler(int nac, P25P1DataUnitID duid)
    {
        mNac = nac;
        mDataUnitID = duid;
