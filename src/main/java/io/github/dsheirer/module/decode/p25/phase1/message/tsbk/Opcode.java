...
public enum Opcode
{
    ...
    OSP_PROTECTION_PARAMETER_BROADCAST(62, "ENCRYPT_PAR_BCST", "ENCRYPTION PARAMETERS BROADCAST"),
    ...
    MOTOROLA_OSP_TALKER_ALIAS(15, "MOTOROLA TALKER ALIAS", "TALKER ALIAS"),
            ...
            case MOTOROLA:
                ...
                else
                {
                    switch(value)
                    {
                        ...
                        case 0x0F:
                            return MOTOROLA_OSP_TALKER_ALIAS;
                        default:
