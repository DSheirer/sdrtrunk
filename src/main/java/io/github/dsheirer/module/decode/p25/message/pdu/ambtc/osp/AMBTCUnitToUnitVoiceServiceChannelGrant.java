...
public class AMBTCUnitToUnitVoiceServiceChannelGrant extends AMBTCMessage implements FrequencyBandReceiver
{
    ...
    public AMBTCUnitToUnitVoiceServiceChannelGrant(PacketSequence packetSequence, int nac, long timestamp)
    {
