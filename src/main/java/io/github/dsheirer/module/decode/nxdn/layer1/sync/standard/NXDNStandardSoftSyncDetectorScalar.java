...
/**
 * Scalar implementation of NXDN Soft Sync Detector.
 */
public class NXDNStandardSoftSyncDetectorScalar extends NXDNStandardSoftSyncDetector
{
    /**
    ...
    public float calculate()
    {
        ...
        for(int x = 0; x < STANDARD_SYNC_DIBIT_LENGTH; x++)
        {
