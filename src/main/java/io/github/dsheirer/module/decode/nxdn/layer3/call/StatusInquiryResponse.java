 ...
 */
public class StatusInquiryResponse extends StatusCall
{
     ...
     * @param lich info
     */
    public StatusInquiryResponse(CorrectedBinaryMessage message, long timestamp, NXDNMessageType type, int ran, LICH lich)
    {
