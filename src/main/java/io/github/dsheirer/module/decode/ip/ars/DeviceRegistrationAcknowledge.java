...
public class DeviceRegistrationAcknowledge extends ARSHeader
{
    /**
     ...
     */
    public DeviceRegistrationAcknowledge(BinaryMessage message, int offset)
    {
    ...
    public String toString()
    {
        ...
        sb.append("DEVICE REGISTRATION ACKNOWLEDGED");
        return sb.toString();
    }
}
