 ...
 * Data call request
 */
public class DataCallReceptionRequest extends DataCallWithOptionalLocation
{
     ...
     * @param lich info
     */
    public DataCallReceptionRequest(CorrectedBinaryMessage message, long timestamp, NXDNMessageType type, int ran, LICH lich)
    {
    ...
    public String toString()
    {
        ...
        sb.append(getCallType()).append(" DATA CALL RECEPTION REQUEST");
