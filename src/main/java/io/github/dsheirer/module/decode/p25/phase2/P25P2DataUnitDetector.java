...
public class P25P2DataUnitDetector implements Listener<Dibit>, ISyncDetectListener
{
    private final static Logger mLog = LoggerFactory.getLogger(P25P2DataUnitDetector.class);
    ...
    private IP25P2DataUnitDetectListener mDataUnitDetectListener;
...
//            else if(mPreviousDataUnitId == P25P2DataUnitID.LOGICAL_LINK_DATA_UNIT_1)
//            {
...
//                mDataUnitDetectListener.dataUnitDetected(P25P2DataUnitID.LOGICAL_LINK_DATA_UNIT_2, -1,
//                    (bitErrorCount + 64), (mDibitsProcessed - DATA_UNIT_DIBIT_LENGTH), new int[63]);
//
//                mPreviousDataUnitId = P25P2DataUnitID.TERMINATOR_DATA_UNIT;
//            }
//            else if(mPreviousDataUnitId == P25P2DataUnitID.LOGICAL_LINK_DATA_UNIT_2)
//            {
//                //We have a good sync match, but the NID didn't pass error control and we're in the middle
//                //of voice call, so treat this message as voice message, but set the previous duid to
//                //terminator so we can end if there isn't a subsequent voice message
//                mDataUnitDetectListener.dataUnitDetected(P25P2DataUnitID.LOGICAL_LINK_DATA_UNIT_1, -1,
//                    (bitErrorCount + 64), (mDibitsProcessed - DATA_UNIT_DIBIT_LENGTH), new int[63]);
//
//                mPreviousDataUnitId = P25P2DataUnitID.TERMINATOR_DATA_UNIT;
//            }
