 ...
 */
public class IdentifierUpdate extends OSPMessage implements IFrequencyBand
{
     ...
     */
    public IdentifierUpdate(DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
