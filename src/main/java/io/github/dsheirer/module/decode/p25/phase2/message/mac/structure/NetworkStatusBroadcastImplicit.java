...
/**
 * Network status broadcast implicit
 */
public class NetworkStatusBroadcastImplicit extends MacStructure implements IFrequencyBandReceiver
{
    ...
    private static final IntField COLOR_CODE = IntField.length12(OCTET_10_BIT_72 + 4);
     ...
     */
    public NetworkStatusBroadcastImplicit(CorrectedBinaryMessage message, int offset)
    {
    ...
    public APCO25Channel getChannel()
    {
        if(mChannel == null)
        {
            P25Channel channel = new P25Channel(getInt(FREQUENCY_BAND),
                getInt(CHANNEL_NUMBER));
