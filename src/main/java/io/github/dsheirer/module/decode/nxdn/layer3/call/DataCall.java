...
/**
 * Data call base implementation
 */
public abstract class DataCall extends Call
{
     ...
     * @param lich info
     */
    public DataCall(CorrectedBinaryMessage message, long timestamp, NXDNMessageType type, int ran, LICH lich)
    {
