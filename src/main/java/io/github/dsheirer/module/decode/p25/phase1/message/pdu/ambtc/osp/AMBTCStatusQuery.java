...
public class AMBTCStatusQuery extends AMBTCMessage
{
    ...
    public APCO25FullyQualifiedRadioIdentifier getTargetAddress()
    {
        ...
        {
            int persona = getHeader().getMessage().getInt(HEADER_ADDRESS);
            ...
            mTargetAddress = APCO25FullyQualifiedRadioIdentifier.createTo(persona, wacn, system, id);
        }
    ...
    public APCO25FullyQualifiedRadioIdentifier getSourceAddress()
    {
        ...
        {
            int persona = getDataBlock(0).getMessage().getInt(BLOCK_0_SOURCE_ADDRESS) << 8;
            persona += getDataBlock(1).getMessage().getInt(BLOCK_1_SOURCE_ADDRESS);
            ...
            mSourceAddress = APCO25FullyQualifiedRadioIdentifier.createFrom(persona, wacn, system, id);
        }
