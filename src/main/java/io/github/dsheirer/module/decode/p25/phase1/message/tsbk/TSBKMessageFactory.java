...
import io.github.dsheirer.module.decode.p25.phase1.message.tsbk.harris.osp.HarrisOpcode48Message;
...
public class TSBKMessageFactory
{
                                     ...
                                     CorrectedBinaryMessage correctedBinaryMessage, int nac, long timestamp)
    {
        ...
        switch(opcode)
        {
            ...
            case HARRIS_OSP_OPCODE_48:
                return new HarrisOpcode48Message(dataUnitID, message, nac, timestamp);
