...
public abstract class Registration extends NXDNLayer3Message
{
    ...
    private static final IntField UNIT_ID = IntField.length16(OCTET_4);
    private static final IntField GROUP_ID = IntField.length16(OCTET_6);
    private static final int LOCATION_ID_OFFSET = OCTET_1 + 5;
    private NXDNFullyQualifiedRadioIdentifier mSourceIdentifier;
     ...
     * @param type
     */
    public Registration(CorrectedBinaryMessage message, long timestamp, NXDNMessageType type)
    {
