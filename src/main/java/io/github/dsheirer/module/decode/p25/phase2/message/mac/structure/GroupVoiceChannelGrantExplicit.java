...
/**
 * Group voice channel grant - explicit
 */
public class GroupVoiceChannelGrantExplicit extends MacStructureVoiceService
        implements IFrequencyBandReceiver, IP25ChannelGrantDetailProvider
{
    ...
    private static final IntField GROUP_ADDRESS = IntField.range(48, 63);
    private static final IntField SOURCE_ADDRESS = IntField.range(64, 87);
     ...
     */
    public GroupVoiceChannelGrantExplicit(CorrectedBinaryMessage message, int offset)
    {
