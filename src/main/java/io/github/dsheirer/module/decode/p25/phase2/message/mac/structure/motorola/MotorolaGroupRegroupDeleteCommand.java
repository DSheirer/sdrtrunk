...
/**
 * Motorola Group Regroup Delete Command.
 */
public class MotorolaGroupRegroupDeleteCommand extends MacStructureVendor
{
    ...
    private List<Identifier> mDeletedTalkgroups;
     ...
     */
    public MotorolaGroupRegroupDeleteCommand(CorrectedBinaryMessage message, int offset)
    {
    ...
    public String toString()
    {
        ...
        sb.append(" DELETE:").append(getDeletedTalkgroups());
        return sb.toString();
    }
    ...
    /**
     * Deleted talkgroups that shall be removed from the patch group
     */
    public List<Identifier> getDeletedTalkgroups()
    {
        if(mDeletedTalkgroups == null)
        {
            mDeletedTalkgroups = new ArrayList<>();

            int tg1 = getInt(TALKGROUP_1);
            if(tg1 > 0)
            {
                mDeletedTalkgroups.add(APCO25Talkgroup.create(tg1));
            }
            ...
            if(length >= 9)
            {
                ...
                if(tg2 > 0)
                {
                    mDeletedTalkgroups.add(APCO25Talkgroup.create(tg2));
                }
            }
            ...
            if(length >= 11)
            {
                ...
                if(tg3 > 0)
                {
                    mDeletedTalkgroups.add(APCO25Talkgroup.create(tg3));
                }
            }
            ...
            if(length >= 13)
            {
                ...
                if(tg4 > 0)
                {
                    mDeletedTalkgroups.add(APCO25Talkgroup.create(tg4));
                }
            }
            ...
            if(length >= 15)
            {
                ...
                if(tg5 > 0)
                {
                    mDeletedTalkgroups.add(APCO25Talkgroup.create(tg5));
                }
            }
            ...
            if(length >= 17)
            {
                ...
                if(tg6 > 0)
                {
                    mDeletedTalkgroups.add(APCO25Talkgroup.create(tg6));
                }
            }
        }

        return mDeletedTalkgroups;
    }
