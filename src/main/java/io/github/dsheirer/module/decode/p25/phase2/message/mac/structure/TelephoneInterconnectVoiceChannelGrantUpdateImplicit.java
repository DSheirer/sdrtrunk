 ...
 */
public class TelephoneInterconnectVoiceChannelGrantUpdateImplicit extends MacStructureVoiceService
{
     ...
     */
    public TelephoneInterconnectVoiceChannelGrantUpdateImplicit(CorrectedBinaryMessage message, int offset)
    {
