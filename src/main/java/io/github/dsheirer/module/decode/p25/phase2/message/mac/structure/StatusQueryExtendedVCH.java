...
/**
 * Status query extended VCH
 */
public class StatusQueryExtendedVCH extends MacStructure
{
    ...
    private static final IntField SOURCE_SUID_SYSTEM = IntField.length12(OCTET_7_BIT_48 + 4);
     ...
     */
    public StatusQueryExtendedVCH(CorrectedBinaryMessage message, int offset)
    {
    ...
    public Identifier getSourceSuid()
    {
        if(mSourceSuid == null)
        {
            ...
            int id = getInt(SOURCE_SUID_ADDRESS);
