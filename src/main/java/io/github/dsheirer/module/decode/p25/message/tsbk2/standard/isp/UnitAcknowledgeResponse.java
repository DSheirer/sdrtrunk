...
public class UnitAcknowledgeResponse extends ISPMessage
{
     ...
     */
    public UnitAcknowledgeResponse(DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
    ...
    {
        return Opcode.fromValue(getMessage().getInt(SERVICE_TYPE), Direction.OUTBOUND);
    }
