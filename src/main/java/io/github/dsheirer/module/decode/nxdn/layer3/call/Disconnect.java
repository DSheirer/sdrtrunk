...
import io.github.dsheirer.module.decode.nxdn.layer3.type.CauseDISC;
 ...
 * Disconnect response
 */
public class Disconnect extends CallWithOptionalLocation
{
     ...
     * @param lich info
     */
    public Disconnect(CorrectedBinaryMessage message, long timestamp, NXDNMessageType type, int ran, LICH lich)
    {
    ...
    public String toString()
    {
        ...
        sb.append(getCallType()).append(" DISCONNECT RESPONSE:").append(getCause());
    ...
    public CauseDISC getCause()
    {
        return CauseDISC.fromValue(getMessage().getInt(CAUSE));
    }
