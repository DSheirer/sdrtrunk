 ...
 * transmitted format.
 *
 * Extended the list of codes from original 83 found in the above referenced specification to the commonly used 104 codes
 * supported in most modern day radios by calculating the Golay values, applying the offset and storing the values bit
 * reversed in decimal notation. - by Paul Donahue (pauldonahue) with help of MS Copilot.
 */
public enum DCSCode
{
    //Inverted codes
