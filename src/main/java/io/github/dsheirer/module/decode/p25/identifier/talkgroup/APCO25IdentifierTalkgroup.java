 ...
 */
public class APCO25IdentifierTalkgroup extends APCO25Talkgroup
{
    public APCO25IdentifierTalkgroup(Integer value, boolean isGroup)
    {
        super(value, Role.IDENTIFIER, isGroup);
    }
    ...
    {
        return new APCO25IdentifierTalkgroup(talkgroup, false);
    }
    ...
    {
        return new APCO25IdentifierTalkgroup(talkgroup, true);
    }
}
