 ...
 */
public class IndividualDataServiceRequest extends ISPMessage
{
     ...
     */
    public IndividualDataServiceRequest(DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
