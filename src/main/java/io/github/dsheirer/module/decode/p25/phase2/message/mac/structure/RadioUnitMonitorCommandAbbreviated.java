 ...
 */
public class RadioUnitMonitorCommandAbbreviated extends RadioUnitMonitorCommand
{
     ...
     */
    public RadioUnitMonitorCommandAbbreviated(CorrectedBinaryMessage message, int offset)
    {
