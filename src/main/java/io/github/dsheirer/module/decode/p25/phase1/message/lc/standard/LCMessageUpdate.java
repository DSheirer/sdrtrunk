...
/**
 * Echo of the short data message from a subscriber when the destination of the update is another subscriber unit.
 */
public class LCMessageUpdate extends LinkControlWord
{
     ...
     * @param message
     */
    public LCMessageUpdate(CorrectedBinaryMessage message)
    {
        super(message);
    }
