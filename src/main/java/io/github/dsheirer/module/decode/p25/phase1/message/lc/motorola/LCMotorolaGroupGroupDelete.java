...
/**
 * Motorola Group Regroup Delete
 */
public class LCMotorolaGroupGroupDelete extends LinkControlWord
{
    ...
    public LCMotorolaGroupGroupDelete(CorrectedBinaryMessage message)
    {
        super(message);
    }
     ...
     * Patch Group
     */
    public Identifier getSuperGroup()
    {
        if(mSuperGroup == null)
        {
            ...
            mSuperGroup = APCO25PatchGroup.create(patchGroup);
        }
    ...
    {
        return getInt(PATCHED_GROUP_2) != 0 &&
            (getInt(SUPERGROUP) != getInt(PATCHED_GROUP_2));
    }
