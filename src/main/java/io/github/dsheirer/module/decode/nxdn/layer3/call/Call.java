...
{
    protected static final IntField CALL_OPTION = IntField.length5(NXDNMessage.OCTET_2 + 3);
    private static final IntField CIPHER_TYPE = IntField.length2(NXDNMessage.OCTET_7);
    private static final IntField KEY_ID = IntField.length6(NXDNMessage.OCTET_7 + 2);
     ...
     */
    public Call(CorrectedBinaryMessage message, long timestamp, NXDNMessageType type)
    {
