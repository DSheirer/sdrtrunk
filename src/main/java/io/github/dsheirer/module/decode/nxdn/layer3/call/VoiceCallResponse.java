 ...
 * Voice call response
 */
public class VoiceCallResponse extends VoiceCallWithOptionalLocation
{
     ...
     * @param lich info
     */
    public VoiceCallResponse(CorrectedBinaryMessage message, long timestamp, NXDNMessageType type, int ran, LICH lich)
    {
