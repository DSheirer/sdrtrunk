 ...
 * Data call request
 */
public class DataCallRequest extends DataCallWithOptionalLocation
{
     ...
     * @param lich info
     */
    public DataCallRequest(CorrectedBinaryMessage message, long timestamp, NXDNMessageType type, int ran, LICH lich)
    {
    ...
    public String toString()
    {
        ...
        sb.append(getCallType()).append(" DATA CALL REQUEST");
