...
/**
 * Terminates transmission on a traffic channel
 */
public class TransmissionRelease extends CallControl
{
     ...
     */
    public TransmissionRelease(CorrectedBinaryMessage message, long timestamp)
    {
    ...
    {
        return NXDNMessageType.TC_TRANSMISSION_RELEASE;
    }
