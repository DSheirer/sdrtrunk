...
public class StatusInquiryResponse extends CallControl
{
    ...
    private static final int OFFSET_LOCATION_ID_PARTIAL = OCTET_9 + 5;
     ...
     */
    public StatusInquiryResponse(CorrectedBinaryMessage message, long timestamp)
    {
    ...
    {
        return NXDNMessageType.TC_STATUS_INQUIRY_RESPONSE;
    }
