...
public class AMBTCStatusQueryRequest extends AMBTCMessage
{
    ...
    public AMBTCStatusQueryRequest(PacketSequence packetSequence, int nac, long timestamp)
    {
    ...
    public IIdentifier getTargetId()
    {
        if(mTargetId == null)
        {
            mTargetId = APCO25ToTalkgroup.createIndividual(getHeader().getMessage().getInt(BLOCK_0_TARGET_ID));
        }
