 ...
 */
public class LCFrequencyBandUpdateExplicit extends LinkControlWord implements IFrequencyBand
{
     ...
     * @param message
     */
    public LCFrequencyBandUpdateExplicit(BinaryMessage message)
    {
        super(message);
    }
