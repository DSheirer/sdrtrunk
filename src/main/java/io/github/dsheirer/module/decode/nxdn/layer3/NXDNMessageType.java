...
public enum NXDNMessageType
{
    ...
    BROADCAST_DIGITAL_STATION_ID_INFORMATION(23, "DIGITAL STATION ID"),
    BROADCAST_SITE_INFORMATION(24, "SITE INFORMATION"),
    BROADCAST_SERVICE_INFORMATION(25, "SERVICE INFORMATION"),
    BROADCAST_CONTROL_CHANNEL_INFORMATION(26, "CONTROL CHANNEL INFORMATION"),
    BROADCAST_ADJACENT_SITE_INFORMATION(27, "ADJACENT SITE INFORMATION"),
    BROADCAST_FAILURE_STATUS_INFORMATION(28, "FAILURE STATUS INFORMATION"),
