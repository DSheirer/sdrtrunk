 ...
 */
public class LastSeenHistory extends HistoryModule<IDecodeEvent> implements IDecodeEventListener
{
    /**
     * Constructs an instance
     */
    public LastSeenHistory(int historySize)
    {
        super(historySize);
    }
     ...
     */
    @Subscribe
    public void process(LastSeenHistoryRequest request)
    {
        getInterModuleEventBus().post(new LastSeenHistoryResponse(this));
    }
}
