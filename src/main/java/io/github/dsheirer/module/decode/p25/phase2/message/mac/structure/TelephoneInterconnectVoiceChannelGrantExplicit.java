 ...
 */
public class TelephoneInterconnectVoiceChannelGrantExplicit extends MacStructureVoiceService
        implements IFrequencyBandReceiver, IP25ChannelGrantDetailProvider
{
     ...
     */
    public TelephoneInterconnectVoiceChannelGrantExplicit(CorrectedBinaryMessage message, int offset)
    {
    ...
    /**
     * Implements the channel grant details provider interface but always returns null.
     */
    @Override
