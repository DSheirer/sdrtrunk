...
public enum DecodeEventType
{
    ...
    CALL("Call"),
    CALL_ENCRYPTED("Call - Encrypted"),
    CALL_GROUP("Call - Group"),
    CALL_GROUP_ENCRYPTED("Call - Group Encrypted"),
    CALL_PATCH_GROUP("Call - Patch Group"),
    CALL_PATCH_GROUP_ENCRYPTED("Call - Patch Group Encrypted"),
    CALL_ALERT("Call Alert"),
    CALL_DETECT("Call Detect"),
    CALL_DO_NOT_MONITOR("Call-Do Not Monitor"),
    CALL_END("Call End"),
    CALL_UNIQUE_ID("UID Call"),
    CALL_UNIT_TO_UNIT("Call - Unit To Unit"),
    CALL_UNIT_TO_UNIT_ENCRYPTED("Call - Unit To Unit Encrypted"),
