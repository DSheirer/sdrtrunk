...
import io.github.dsheirer.module.decode.nxdn.layer3.type.CauseDREQ;
 ...
 * Disconnect request
 */
public class DisconnectRequest extends CallWithOptionalLocation
{
     ...
     * @param lich info
     */
    public DisconnectRequest(CorrectedBinaryMessage message, long timestamp, NXDNMessageType type, int ran, LICH lich)
    {
    ...
    public String toString()
    {
        ...
        sb.append(getCallType()).append(" DISCONNECT REQUEST:").append(getCause());
    ...
    public CauseDREQ getCause()
    {
        return CauseDREQ.fromValue(getMessage().getInt(CAUSE));
    }
