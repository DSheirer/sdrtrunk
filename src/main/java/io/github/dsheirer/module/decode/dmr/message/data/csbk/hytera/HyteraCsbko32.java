 ...
 */
public class HyteraCsbko32 extends CSBKMessage
{
     ...
     * @param timeslot
     */
    public HyteraCsbko32(DMRSyncPattern syncPattern, CorrectedBinaryMessage message, CACH cach, SlotType slotType, long timestamp, int timeslot)
    {
    ...
    public String toString()
    {
        ...
        sb.append(" HYTERA CSBKO=32 PROBABLE ACKNOWLEDGE RESPONSE");
