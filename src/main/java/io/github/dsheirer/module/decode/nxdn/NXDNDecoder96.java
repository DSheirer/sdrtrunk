 ...
 *
 */
public class NXDNDecoder96 extends FeedbackDecoder implements IByteBufferProvider, IComplexSamplesListener,
        ISourceEventListener, ISourceEventProvider, Listener<ComplexSamples>
{
    private static final Logger LOGGER = LoggerFactory.getLogger(NXDNDecoder96.class);
    private static final DecimalFormat DECIMAL_FORMAT = new DecimalFormat("#.##");
    private static final int SYMBOL_RATE = 4800;
    private static final Map<Double,float[]> BASEBAND_FILTERS = new HashMap<>();

    private final NXDNDemodulator96 mSymbolProcessor;
    ...
    public NXDNDecoder96()
    {
        mMessageProcessor.setMessageListener(getMessageListener());
        mSymbolProcessor = new NXDNDemodulator96(mMessageFramer, this);
    }
...
//        String file = directory + "P25-S3-C4FM-20241225_040459_152517500_NYSEG_Onondaga_Control_30_baseband.wav";
        ...
        NXDNDecoder96 decoder = new NXDNDecoder96();
        decoder.start();
