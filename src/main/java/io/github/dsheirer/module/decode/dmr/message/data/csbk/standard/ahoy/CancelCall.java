...
/**
 * DMR Tier III Ahoy - Cancel Call
 */
public class CancelCall extends Ahoy
{
     ...
     * @param timeslot
     */
    public CancelCall(DMRSyncPattern syncPattern, CorrectedBinaryMessage message, CACH cach, SlotType slotType, long timestamp, int timeslot)
    {
    ...
    public String toString()
    {
        ...
        sb.append(" CANCEL CALL TO:").append(getTargetAddress());
