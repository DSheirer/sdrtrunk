...
public class AMBTCTelephoneInterconnectChannelGrant extends AMBTCMessage implements FrequencyBandReceiver
{
    ...
    public AMBTCTelephoneInterconnectChannelGrant(PacketSequence packetSequence, int nac, long timestamp)
    {
