...
public class AMBTCGroupAffiliationResponse extends AMBTCMessage
{
    ...
    public APCO25FullyQualifiedTalkgroupIdentifier getGroupAddress()
    {
        ...
        {
            int persona = getDataBlock(0).getMessage().getInt(BLOCK_0_GROUP_ADDRESS);
            ...
            mGroupAddress = APCO25FullyQualifiedTalkgroupIdentifier.createAny(persona, wacn, system, id);
        }
