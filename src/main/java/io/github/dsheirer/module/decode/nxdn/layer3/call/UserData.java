...
public abstract class UserData extends NXDNLayer3Message
{
    ...
    {
        return getMessage().getSubMessage(OFFSET_USER_DATA, OFFSET_USER_DATA + (getUserDataByteLength() * 8));
    }
    ...
    {
        return getMessage().getSubMessage(OFFSET_USER_DATA, OFFSET_USER_DATA + ((getUserDataByteLength() - padOctets) * 8));
    }
