 ...
 */
public class ShortDataCallRequestHeader extends DataCallWithOptionalLocation implements IPacketHeader
{
     ...
     * @param lich info
     */
    public ShortDataCallRequestHeader(CorrectedBinaryMessage message, long timestamp, NXDNMessageType type, int ran, LICH lich)
    {
    ...
    public String toString()
    {
        ...
        sb.append("SHORT DATA CALL REQUEST HEADER");
    ...
    public PacketInformation getPacketInformation()
    {
        ...
        {
            mPacketInformation = new PacketInformation(getMessage(), OFFSET_PACKET_INFORMATION, false);
        }
