 ...
 */
public class ShortDataCallRequestHeader extends DataCall
{
     ...
     */
    public ShortDataCallRequestHeader(CorrectedBinaryMessage message, long timestamp)
    {
    ...
    {
        return NXDNMessageType.TC_SHORT_DATA_CALL_REQUEST_HEADER;
    }
