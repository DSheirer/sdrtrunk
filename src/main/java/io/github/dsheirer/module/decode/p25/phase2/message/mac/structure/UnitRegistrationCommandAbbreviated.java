...
/**
 * Unit registration command - abbreviated format
 */
public class UnitRegistrationCommandAbbreviated extends MacStructure
{
     ...
     */
    public UnitRegistrationCommandAbbreviated(CorrectedBinaryMessage message, int offset)
    {
