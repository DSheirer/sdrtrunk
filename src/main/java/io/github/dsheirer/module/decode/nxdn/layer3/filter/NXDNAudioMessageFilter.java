...
/**
 * NXDN Audio message filter
 */
public class NXDNAudioMessageFilter extends Filter<IMessage, String>
{
	private static final String KEY = "Audio Message";
	private final Extractor mKeyExtractor = new Extractor();

	/**
	 * Constructor
	 */
    public NXDNAudioMessageFilter()
    {
        super("Audio");
