...
/**
 * Group voice service request - abbreviated format
 */
public class GroupVoiceServiceRequest extends MacStructure
{
     ...
     */
    public GroupVoiceServiceRequest(CorrectedBinaryMessage message, int offset)
    {
