...
import io.github.dsheirer.module.decode.p25.phase1.NACTracker;
...
public class NXDNMessageFramer
{
    ...
    private NXDNMessageAssembler mMessageAssembler;
    ...
    public boolean process(Dibit symbol)
    {
        ...
        else if(mDibitCounter == 57)
        {
            ...
            {
                mMessageAssembler = new NXDNMessageAssembler(mDetectedNAC, mDetectedDataUnitID);
