...
{
    private static final int[] STACK_OPERATION = {16, 17, 18, 19, 20, 21, 22, 23};
     ...
     */
    public RoamingAddressCommand(DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
