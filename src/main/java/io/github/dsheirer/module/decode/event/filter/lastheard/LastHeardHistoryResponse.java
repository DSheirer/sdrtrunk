 ...
 */
public class LastHeardHistoryResponse extends ModuleEventBusMessage
{
    private LastHeardHistory mLastHeardHistory;

    /**
     * Constructs an instance
     * @param history that has a decode event history
     */
    public LastHeardHistoryResponse(LastHeardHistory history)
    {
        mLastHeardHistory = history;
    }

    /**
     * Decode event history module
     */
    public LastHeardHistory getDecodeEventHistory()
    {
        return mLastHeardHistory;
    }
}
