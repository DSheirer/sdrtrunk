 ...
 */
public class VectorHilbertTransform256Bits extends HilbertTransform
{
    ...
    public ComplexSamples filter(float[] realSamples, long timestamp)
    {
        ...
        FloatVector filterB = FloatVector.fromArray(VECTOR_SPECIES, mCoefficients, 8);
        FloatVector filterC = FloatVector.fromArray(VECTOR_SPECIES, mCoefficients, 16);
        ...
        for(int x = 0; x < bufferLength; x++)
        {
            ...
            accumulator = filterC.fma(FloatVector.fromArray(VECTOR_SPECIES, mQBuffer, x + 16), accumulator);
