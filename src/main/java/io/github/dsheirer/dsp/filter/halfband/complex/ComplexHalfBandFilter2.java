...
public class ComplexHalfBandFilter2
{
    private ReusableComplexBufferQueue mBufferQueue = new ReusableComplexBufferQueue("ComplexHalfBandFilter2");
    ...
    public ComplexHalfBandFilter2(float[] coefficients, float gain)
    {
    ...
    public static void main(String[] args)
    {
        ...
        ComplexHalfBandFilter2 filter = new ComplexHalfBandFilter2(Filters.HALF_BAND_FILTER_27T.getCoefficients(), 1.0f);
