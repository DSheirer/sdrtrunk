...
/**
 * Noise Squelch operating status.  Captures a snapshot in time of the squelch status.
...
public record NoiseSquelchState(boolean squelch, boolean squelchOverride, float noise, float noiseOpenThreshold,
                                float noiseCloseThreshold, int hysteresis, int hysteresisOpenThreshold, int hysteresisCloseThreshold)
{
}
