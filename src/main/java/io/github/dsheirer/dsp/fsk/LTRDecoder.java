 ...
 */
public class LTRDecoder implements Listener<FloatBuffer>, ISyncDetectListener, ISyncStateListener
{
    ...
    {
        FloatBuffer dcFiltered = mDCFilter.filter(buffer);
        FloatBuffer lowPassFiltered = mLowPassFilter.filter(dcFiltered);
