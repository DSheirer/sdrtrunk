 ...
 */
public class ScalarDmrSyncDetector2
{
    ...
    private static final float[] BASE_DATA = DMRSyncPattern.BASE_STATION_DATA.toSymbols();
    private static final float[] BASE_VOICE = DMRSyncPattern.BASE_STATION_VOICE.toSymbols();
    private static final float[] MOBILE_DATA = DMRSyncPattern.MOBILE_STATION_DATA.toSymbols();
    private static final float[] MOBILE_VOICE = DMRSyncPattern.MOBILE_STATION_VOICE.toSymbols();
    private static final float[] DIRECT_DATA_1 = DMRSyncPattern.DIRECT_MODE_DATA_TIMESLOT_1.toSymbols();
    private static final float[] DIRECT_DATA_2 = DMRSyncPattern.DIRECT_MODE_DATA_TIMESLOT_2.toSymbols();
    private static final float[] DIRECT_VOICE_1 = DMRSyncPattern.DIRECT_MODE_VOICE_TIMESLOT_1.toSymbols();
    private static final float[] DIRECT_VOICE_2 = DMRSyncPattern.DIRECT_MODE_VOICE_TIMESLOT_2.toSymbols();
    ...
    private DMRSyncPattern mDetectedPattern = DMRSyncPattern.BASE_STATION_DATA;

    public ScalarDmrSyncDetector2()
    {
    }
        ...
        switch(mMode)
        {
            case AUTOMATIC:
                ...
                if(allDirectData1 > allBestScore)
                {
                    ...
                    mDetectedPattern = DMRSyncPattern.DIRECT_MODE_DATA_TIMESLOT_1;
                }

                if(allDirectData2 > allBestScore)
                {
                    allBestScore = allDirectData2;
                    mDetectedPattern = DMRSyncPattern.DIRECT_MODE_DATA_TIMESLOT_2;
                }

                if(allDirectVoice1 > allBestScore)
                {
                    allBestScore = allDirectVoice1;
                    mDetectedPattern = DMRSyncPattern.DIRECT_MODE_VOICE_TIMESLOT_1;
                }

                if(allDirectVoice2 > allBestScore)
                {
                    allBestScore = allDirectVoice2;
                    mDetectedPattern = DMRSyncPattern.DIRECT_MODE_VOICE_TIMESLOT_2;
                }
