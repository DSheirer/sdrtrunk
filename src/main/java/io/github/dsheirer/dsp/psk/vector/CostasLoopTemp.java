 ...
 */
public class CostasLoopTemp implements IPhaseLockedLoop
{
    private final static Logger mLog = LoggerFactory.getLogger(CostasLoopTemp.class);
     ...
     */
    public CostasLoopTemp(double sampleRate, double symbolRate)
    {
    ...
    public void setLoopFrequency(double frequency)
    {
        mLoopFrequency = frequency;
    }
