...
public class DmrSyncModeMonitor
{
    ...
    private final List<DmrSoftSyncDetector> mSyncDetectors = new ArrayList<>();
    ...
    public void setMode(DmrSyncDetectMode mode)
    {
        ...
        for(DmrSoftSyncDetector detector : mSyncDetectors)
        {
     ...
     * @param syncDetector
     */
    public void add(DmrSoftSyncDetector syncDetector)
    {
