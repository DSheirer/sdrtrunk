...
/**
 * Monitors sync pattern detections to automatically detect the prevailing sync mode group used on a channel and
 * optimizes the DMR sync detectors to limit the quantity of false detects for unused sync patterns and the overall
 * sync detection processing workload.
 */
public class DmrSyncModeMonitor
{
    private static int DOMINANT_THRESHOLD = 10;
    ...
    private List<ScalarDmrSyncDetector2> mSyncDetectors = new ArrayList<>();
    ...
    public void setMode(DmrSyncDetectMode mode)
    {
        ...
        for(ScalarDmrSyncDetector2 detector : mSyncDetectors)
        {
     ...
     * @param syncDetector
     */
    public void add(ScalarDmrSyncDetector2 syncDetector)
    {
