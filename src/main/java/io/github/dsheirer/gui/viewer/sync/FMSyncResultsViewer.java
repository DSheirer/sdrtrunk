 ...
 */
public class FMSyncResultsViewer implements ISyncResultsListener
{
    private static final Logger LOGGER = LoggerFactory.getLogger(FMSyncResultsViewer.class.getName());
    private ISyncResultsListener mListener;

    public FMSyncResultsViewer()
    {
        initUI();
    }
    ...
    private void initUI()
    {
        ...
        Platform.runLater(() -> {
            ...
            FMSyncVisualizer syncVisualizer = new FMSyncVisualizer();
...
//            }
            ...
            frame.setTitle("FM Sync Results Viewer");
