...
public class SampleGenerator
{
    ...
    private Queue<SourceEvent> mSourceEventQueue = new ConcurrentLinkedQueue();
    ...
    /**
     * Queues the source event for inclusion in the complex buffers generated by this sample generator.  Source events
     * are queued FIFO and embedded one at a time in the subsequent buffers produced by this generator.
     * @param sourceEvent to queue
     */
    public void queue(SourceEvent sourceEvent)
    {
        mSourceEventQueue.offer(sourceEvent);
    }
    ...
    public class Generator implements Runnable
    {
        ...
        public void run()
        {
            if(mListener != null)
            {
                ...
                mListener.receive(new TimestampedComplexBuffer(samples, mSourceEventQueue.poll()));
