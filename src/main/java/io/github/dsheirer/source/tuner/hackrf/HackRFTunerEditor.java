...
public class HackRFTunerEditor extends TunerConfigurationEditor
{
    ...
    private JComboBox<HackRFTunerController.HackRFSampleRate> mComboSampleRate;
    private JSpinner mFrequencyCorrection;
    private JToggleButton mAmplifier;
    private JComboBox<HackRFTunerController.HackRFLNAGain> mComboLNAGain;
    private JComboBox<HackRFTunerController.HackRFVGAGain> mComboVGAGain;
    ...
    private void init()
    {
        ...
        mComboSampleRate = new JComboBox<>( HackRFTunerController.HackRFSampleRate.values() );
        ...
        mComboSampleRate.addActionListener( new ActionListener() 
        {
            ...
            public void actionPerformed( ActionEvent e )
            {
				HackRFTunerController.HackRFSampleRate sampleRate =
						(HackRFTunerController.HackRFSampleRate)mComboSampleRate.getSelectedItem();
				try
                {
        ...
        mComboLNAGain = new JComboBox<HackRFTunerController.HackRFLNAGain>( HackRFTunerController.HackRFLNAGain.values() );
        ...
        mComboLNAGain.addActionListener( new ActionListener() 
        {
            ...
            public void actionPerformed( ActionEvent arg0 )
            {
				try
                {
					HackRFTunerController.HackRFLNAGain lnaGain = (HackRFTunerController.HackRFLNAGain)mComboLNAGain.getSelectedItem();
					
					if ( lnaGain == null )
					{
						lnaGain = HackRFTunerController.HackRFLNAGain.GAIN_0;
					}
        ...
        mComboVGAGain = new JComboBox<HackRFTunerController.HackRFVGAGain>( HackRFTunerController.HackRFVGAGain.values() );
        mComboVGAGain.addActionListener( new ActionListener() 
        {
            ...
            public void actionPerformed( ActionEvent arg0 )
            {
				try
                {
					HackRFTunerController.HackRFVGAGain vgaGain = (HackRFTunerController.HackRFVGAGain)mComboVGAGain.getSelectedItem();

					if( vgaGain == null )
					{
						vgaGain = HackRFTunerController.HackRFVGAGain.GAIN_4;
					}
	...
	public void save()
	{
    	if( hasItem() && !mLoading )
    	{
    		...
    		config.setSampleRate( (HackRFTunerController.HackRFSampleRate)mComboSampleRate.getSelectedItem() );
    		config.setAmplifierEnabled( mAmplifier.isSelected() );
    		config.setLNAGain( (HackRFTunerController.HackRFLNAGain)mComboLNAGain.getSelectedItem() );
    		config.setVGAGain( (HackRFTunerController.HackRFVGAGain)mComboVGAGain.getSelectedItem() );
