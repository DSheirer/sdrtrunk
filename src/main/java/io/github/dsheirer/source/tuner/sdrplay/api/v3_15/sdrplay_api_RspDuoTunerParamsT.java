...
public class sdrplay_api_RspDuoTunerParamsT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        sdrplay_api_RspDuo_ResetSlaveFlagsT.layout().withName("resetSlaveFlags"),
        MemoryLayout.paddingLayout(3)
    ).withName("$anon$37:9");
    ...
    private static final GroupLayout resetSlaveFlags$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("resetSlaveFlags"));
     ...
     * }
     */
    public static final GroupLayout resetSlaveFlags$layout() {
        return resetSlaveFlags$LAYOUT;
    }

    private static final long resetSlaveFlags$OFFSET = 11;
     ...
     * }
     */
    public static final long resetSlaveFlags$offset() {
        return resetSlaveFlags$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment resetSlaveFlags(MemorySegment struct) {
        return struct.asSlice(resetSlaveFlags$OFFSET, resetSlaveFlags$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void resetSlaveFlags(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, resetSlaveFlags$OFFSET, resetSlaveFlags$LAYOUT.byteSize());
    }
