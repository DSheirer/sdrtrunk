...
import io.github.dsheirer.source.tuner.TunerSourceMultipleFrequencyEditor;
...
public class SourceConfigurationEditor extends Editor<Channel>
{
    ...
    private TunerSourceMultipleFrequencyEditor mTunerSourceMultipleFrequencyEditor;
    ...
    public SourceConfigurationEditor(SourceManager sourceManager)
    {
        ...
        mTunerSourceMultipleFrequencyEditor = new TunerSourceMultipleFrequencyEditor(sourceManager.getTunerModel());
        mTunerSourceMultipleFrequencyEditor.setSaveRequestListener(this);
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                switch(selected)
                {
                    ...
                    case TUNER_MULTIPLE_FREQUENCIES:
                        setEditor(mTunerSourceMultipleFrequencyEditor);
                        break;
                    default:
