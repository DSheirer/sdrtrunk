...
public class RealDecibelConverter extends DFTResultsConverter
{
	 ...
	 * calculation into a normalized power ua.in.smartjava.spectrum in decibels, per description
	 * in Lyons, Understanding Digital Signal Processing, 3e, page 141.
	 * 
	 * Note: this is only calculating the lower half of the ua.in.smartjava.spectrum
	 */
	@Override
