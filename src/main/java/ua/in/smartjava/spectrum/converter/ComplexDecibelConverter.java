 ...
 ******************************************************************************/
package ua.in.smartjava.spectrum.converter;
 ...
 * dynamic range supported by the ua.in.smartjava.source.  Maximum dynamic range for bit depth
 * is calculated as:
 * 
 * 20 * log10( 1 / ( 2 ^ ( bit depth - 1 ) )
 * 
 * A ua.in.smartjava.source that provides 12-bit samples can produce values in the range of
 * ( 0 to 4096 ) or -2048 to 2047.  The smallest observable value would then
 * be 1 / 2048.
 * 
 * So, the smallest decibel value of a ua.in.smartjava.source producing 12 bit samples is:
 * 
...
public class ComplexDecibelConverter extends DFTResultsConverter
{
	 ...
	 * calculation into the power ua.in.smartjava.spectrum in decibels, normalized to the
	 * ua.in.smartjava.sample bit depth.
	 */
