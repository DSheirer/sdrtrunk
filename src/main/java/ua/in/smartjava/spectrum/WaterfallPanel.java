													  ...
													  SettingChangeListener
{
	 ...
	 * time.  Maps DFT frequency bin decibel values into a 256 bucket color ua.in.smartjava.map
	 * for display.
	 * 
	...
	/**
	 * Resets the memory image ua.in.smartjava.source and byte backing array when the DFT point
	 * size has changed
	 */
	private void reset()
	{
    ...
    {
		//If our FFT size changes, reset our pixel ua.in.smartjava.map and image ua.in.smartjava.source
