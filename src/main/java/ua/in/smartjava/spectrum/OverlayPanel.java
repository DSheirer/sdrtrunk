        ...
        SettingChangeListener
{
    ...
    /**
     * Translucent overlay panel for displaying ua.in.smartjava.channel configurations,
    ...
    public OverlayPanel(SettingsManager settingsManager, ChannelModel channelModel)
    {
        ...
        //Set the background transparent, so the ua.in.smartjava.spectrum display can be seen
        setOpaque(false);
    ...
    /**
     * Renders the ua.in.smartjava.channel configs, lines, labels, and cursor
     */
    @Override
    ...
    /**
     * Draws the Automatic Frequency Control (AFC) ua.in.smartjava.channel center offset
     */
    ...
    /**
     * Draws visible ua.in.smartjava.channel configs as translucent shaded frequency regions
     */
        ...
        for(Channel channel : mVisibleChannels)
        {
                ...
                (mChannelDisplay == ChannelDisplay.ENABLED && channel.getEnabled()))
            {
                ...
                if(tunerChannel != null)
                {
                    ...
                    //Change to the line color to render the ua.in.smartjava.channel name, etc.
                    graphics.setColor(mColorSpectrumLine);
                    ...
                    //Draw the ua.in.smartjava.channel label and adjust the y-axis position
    ...
    /**
     * Returns a list of ua.in.smartjava.channel configs that contain the frequency within their
