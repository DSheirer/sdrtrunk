...
import ua.in.smartjava.dsp.filter.smoothing.GaussianSmoothingFilter;
import ua.in.smartjava.dsp.filter.smoothing.NoSmoothingFilter;
import ua.in.smartjava.dsp.filter.smoothing.RectangularSmoothingFilter;
import ua.in.smartjava.dsp.filter.smoothing.SmoothingFilter;
import ua.in.smartjava.dsp.filter.smoothing.SmoothingFilter.SmoothingType;
import ua.in.smartjava.dsp.filter.smoothing.TriangularSmoothingFilter;
...
public class SpectrumPanel extends JPanel implements DFTResultsListener, SettingChangeListener, SpectralDisplayAdjuster
{
    ...
    //Reference dB value set according to the ua.in.smartjava.source ua.in.smartjava.sample size
    ...
    /**
     * Draws the current fft ua.in.smartjava.spectrum with a line and a gradient fill.
     */
    private void drawSpectrum(Graphics2D graphics)
    {
        ...
        //Otherwise show an empty ua.in.smartjava.spectrum
        else
        {
            //Draw Left Size
        ...
        //Draw the bottom line under the ua.in.smartjava.spectrum
    ...
    /**
     * Sets the ua.in.smartjava.source ua.in.smartjava.sample size in ua.in.smartjava.bits which defines the lowest dB value to
     * display in the ua.in.smartjava.spectrum
     *
     * @param sampleSize in ua.in.smartjava.bits
     */
    ...
    /**
     * Returns the current smoothing ua.in.smartjava.filter type
     */
    @Override
    ...
    /**
     * Sets the smoothing ua.in.smartjava.filter type
     */
    @Override
