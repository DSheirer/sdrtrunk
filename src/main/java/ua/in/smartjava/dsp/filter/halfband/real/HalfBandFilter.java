...
public class HalfBandFilter
{
	...
	/**
	 * Half-Band ua.in.smartjava.filter for processing real float samples.
	 * 
	...
	/**
	 * Inserts the ua.in.smartjava.sample into the ua.in.smartjava.buffer without calculating a filtered value
	 */
