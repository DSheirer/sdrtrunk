package ua.in.smartjava.dsp.filter.design;
...
public class FilterViewer extends Application
{
    ...
    /**
     * Developer tool to visualize ua.in.smartjava.filter designs
     */
    public FilterViewer()
    {
    }
    ...
    /**
     * Provides the ua.in.smartjava.filter to visualize.  Modify this method to visualize your ua.in.smartjava.filter design.
     */
