...
import ua.in.smartjava.dsp.filter.fir.real.RealFIRFilter;
...
public class ComplexFIRFilter extends FIRFilter
{
	...
	/**
	 * Complex FIR Filter for processing complex ua.in.smartjava.sample pairs.  Wraps two real
	 * FIR filters for processing each of the inphase and quadrature samples.
	 * 
	 * @param coefficients - ua.in.smartjava.filter taps
