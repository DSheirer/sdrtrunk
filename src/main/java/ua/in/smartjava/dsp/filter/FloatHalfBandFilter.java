...
public class FloatHalfBandFilter implements RealSampleListener
{
	...
	/**
	 * Half-Band ua.in.smartjava.filter with decimation by 2 against real valued floats.
	 * 
	...
	public void receive( float newSample )
	{
		...
		//ua.in.smartjava.sample every other time, when the flag is true (ie decimate by 2)
		mDispatchFlag = !mDispatchFlag;
		
		//Calculate a filtered ua.in.smartjava.sample when the flag is true
		if( mDispatchFlag )
		{
