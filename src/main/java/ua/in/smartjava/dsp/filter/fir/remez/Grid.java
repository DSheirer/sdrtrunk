...
import ua.in.smartjava.dsp.filter.fir.FIRFilterSpecification.FrequencyBand;
...
public class Grid
{
    ...
    /**
     * Creates a dense frequency grid from the ua.in.smartjava.filter specification for those frequency bands
    ...
    private void create( FIRFilterSpecification specification )
    {
        ...
        {
        	FrequencyBand band = specification.getFrequencyBands().get( x );
