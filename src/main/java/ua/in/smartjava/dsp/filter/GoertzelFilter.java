...
public class GoertzelFilter
{
     ...
     * 
     * @param sampleRate
     *            - ua.in.smartjava.sample rate (Hz)
    ...
    /**
     * Establish the pre-calculated values to use in the ua.in.smartjava.filter
     */
    private void init()
    {
     ...
     * @throws IllegalArgumentException if the ua.in.smartjava.sample array size is not equal
    ...
    /**
     * Sums all of the ua.in.smartjava.sample values to derive the bin 0 power
     */
