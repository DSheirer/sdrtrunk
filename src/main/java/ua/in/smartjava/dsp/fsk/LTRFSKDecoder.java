...
import ua.in.smartjava.dsp.filter.FloatHalfBandFilter;
import ua.in.smartjava.dsp.filter.FloatHalfBandNoDecimateFilter;
import ua.in.smartjava.dsp.filter.LTRPulseShapingFilter;
import ua.in.smartjava.dsp.filter.SquaringFilter;
import ua.in.smartjava.dsp.filter.Window.WindowType;
import ua.in.smartjava.dsp.filter.cic.RealPrimeCICDecimate;
import ua.in.smartjava.dsp.filter.dc.IIRSinglePoleDCRemovalFilter;
import ua.in.smartjava.dsp.symbol.Slicer;
import ua.in.smartjava.dsp.symbol.Slicer.Output;
...
public class LTRFSKDecoder implements Listener<RealBuffer>, Instrumentable
{
	 ...
	 * decoder.  Expects a 48000 ua.in.smartjava.sample rate input.
	 */
