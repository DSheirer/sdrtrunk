 ...
 ******************************************************************************/
package ua.in.smartjava.dsp.fsk;

import ua.in.smartjava.buffer.BooleanAveragingBuffer;
import ua.in.smartjava.dsp.symbol.SymbolEvent;
import ua.in.smartjava.dsp.symbol.SymbolEvent.Shift;
 ...
 * rate to be an integer multiple of the ua.in.smartjava.sample rate.
 *
 ...
 *
 * Use a DC-removal ua.in.smartjava.filter prior to this decoder to ensure samples don't have
 * a DC component.
 *
...
public class FSK2Decoder implements Instrumentable, Listener<RealBuffer>
{
    ...
    /**
     * Primary ua.in.smartjava.sample input
     */
    @Override
    public void receive(RealBuffer buffer)
    {
        ...
        {
			/* Square the ua.in.smartjava.sample.  Greater than zero is a 1 (true) and less than
			 * zero is a 0 (false) */
            boolean bitSample = (sample >= 0.0f);

			/* Feed the delay ua.in.smartjava.buffer and fetch the one-baud delayed ua.in.smartjava.sample */
			...
			/* Low pass ua.in.smartjava.filter to smooth the correlated values */
    ...
    /**
     * Registers a listener to receive the decoded FSK ua.in.smartjava.bits
     */
