 ...
 ******************************************************************************/
package ua.in.smartjava.dsp.mixer;
...
public class Oscillator
{
	 ...
	 * oscillating at the specified frequency and ua.in.smartjava.sample rate
	 * 
	...
	/**
	 * Updates the internal values after a frequency or ua.in.smartjava.sample rate change
	 */
	private void update()
	{
	...
	/**
	 * Sets or changes the ua.in.smartjava.sample rate of this oscillator
	 */
	...
	/**
	 * Steps the current angle by the angle per ua.in.smartjava.sample amount
	 */
	public void rotate()
	{
	...
	/**
	 * Get next complex ua.in.smartjava.sample
	 */
	...
	/**
	 * Get the next float ua.in.smartjava.sample
	 */
