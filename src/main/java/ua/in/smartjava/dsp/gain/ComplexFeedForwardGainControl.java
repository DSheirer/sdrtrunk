...
import ua.in.smartjava.buffer.FloatCircularBuffer;
...
public class ComplexFeedForwardGainControl implements ComplexSampleListener
{
	...
	/**
	 * Dynamic gain control for incoming ua.in.smartjava.sample stream to amplify or attenuate
	...
	public void receive( float inphase, float quadrature )
	{
		...
		/* Apply current gain value to the ua.in.smartjava.sample and send to the listener */
		if( mListener != null )
		{
