...
public abstract class BroadcastConfigurationEditor extends DocumentListenerEditor<BroadcastConfiguration>
{
     ...
     * ua.in.smartjava.channel ua.in.smartjava.alias id with the old name to update to the new name.
     *
     * @param broadcastConfiguration to assign a new ua.in.smartjava.channel name
