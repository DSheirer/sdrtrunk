...
public class BroadcastEvent
{
    ...
    /**
     * AliasEvent - event describing any changes to an ua.in.smartjava.alias
     *
     * @param configuration - ua.in.smartjava.alias that changed
    ...
    /**
     * Indicates if this event pertains to an ua.in.smartjava.audio broadcaster
     */
