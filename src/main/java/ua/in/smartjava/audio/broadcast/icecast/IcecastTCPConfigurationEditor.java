...
import ua.in.smartjava.audio.broadcast.BroadcastConfigurationEditor;
...
public class IcecastTCPConfigurationEditor extends BroadcastConfigurationEditor
{
    ...
    public IcecastTCPConfigurationEditor(BroadcastModel broadcastModel, AliasModel aliasModel, IconManager iconManager)
    {
