 ...
 *
 ******************************************************************************/
package ua.in.smartjava.audio.broadcast.icecast;

import ua.in.smartjava.audio.broadcast.BroadcastState;
import ua.in.smartjava.audio.broadcast.icecast.codec.IcecastCodecFactory;
...
//                mSocketConnector.getFilterChain().addLast("logger", loggingFilter);
    ...
    public class IcecastTCPIOHandler extends IoHandlerAdapter
    {
        ...
        public void messageReceived(IoSession session, Object object) throws Exception
        {
            ...
            {
                mLog.error("[" + getStreamName() + "]Icecast TCP broadcaster - unrecognized ua.in.smartjava.message [ " + object.getClass() +
