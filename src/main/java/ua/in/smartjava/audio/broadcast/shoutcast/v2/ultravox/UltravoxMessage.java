...
public abstract class UltravoxMessage
{
    ...
    /**
     * Sets the ultravox sync ua.in.smartjava.bits to the predefined sync pattern: 01011010 (0x5A)
     */
    ...
    /**
     * Sets the ultravox ua.in.smartjava.bits according to the ultravox class and type
    ...
    /**
     * Indicates if the response ua.in.smartjava.message contains an error ua.in.smartjava.message.
     */
    ...
    /**
     * Textual ua.in.smartjava.message available when the error response flag is set.
     */
