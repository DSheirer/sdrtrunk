 ...
 *
 ******************************************************************************/
package ua.in.smartjava.audio.broadcast.icecast.codec;
...
public class IcecastCodecFactory implements ProtocolCodecFactory
{
    ...
    /**
     * Factory for codecs to process Icecast string protocol and byte array ua.in.smartjava.audio frames for use with Apache Mina
     */
