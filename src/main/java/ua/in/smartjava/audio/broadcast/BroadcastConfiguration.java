...
public abstract class BroadcastConfiguration
{
    ...
    /**
     * Broadcast ua.in.smartjava.audio streaming configuration.  Describes the streaming server and configuration details.
     */
    ...
    /**
     * Audio broadcastAudio delay from recording start until the ua.in.smartjava.audio file is broadcastAudio to the server.
     */
    ...
    /**
     * User specified delay in milli-seconds from ua.in.smartjava.audio call start until when the ua.in.smartjava.audio is broadcastAudio to the server.
