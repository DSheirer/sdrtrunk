 ...
 *
 ******************************************************************************/
package ua.in.smartjava.audio.broadcast.shoutcast.v2;

import ua.in.smartjava.audio.broadcast.AudioBroadcaster;
import ua.in.smartjava.audio.broadcast.BroadcastState;
import ua.in.smartjava.audio.broadcast.IBroadcastMetadataUpdater;
import ua.in.smartjava.audio.broadcast.shoutcast.v2.ultravox.AuthenticateBroadcast;
import ua.in.smartjava.audio.broadcast.shoutcast.v2.ultravox.CacheableXMLMetadata;
import ua.in.smartjava.audio.broadcast.shoutcast.v2.ultravox.ConfigureIcyName;
import ua.in.smartjava.audio.broadcast.shoutcast.v2.ultravox.ConfigureIcyPublic;
import ua.in.smartjava.audio.broadcast.shoutcast.v2.ultravox.MP3Audio;
import ua.in.smartjava.audio.broadcast.shoutcast.v2.ultravox.NegotiateMaxPayloadSize;
import ua.in.smartjava.audio.broadcast.shoutcast.v2.ultravox.RequestCipher;
import ua.in.smartjava.audio.broadcast.shoutcast.v2.ultravox.SetupBroadcast;
import ua.in.smartjava.audio.broadcast.shoutcast.v2.ultravox.Standby;
import ua.in.smartjava.audio.broadcast.shoutcast.v2.ultravox.StreamMimeType;
import ua.in.smartjava.audio.broadcast.shoutcast.v2.ultravox.UltravoxMessage;
import ua.in.smartjava.audio.broadcast.shoutcast.v2.ultravox.UltravoxMessageFactory;
import ua.in.smartjava.audio.broadcast.shoutcast.v2.ultravox.UltravoxMessageType;
import ua.in.smartjava.audio.broadcast.shoutcast.v2.ultravox.UltravoxMetadata;
import ua.in.smartjava.audio.broadcast.shoutcast.v2.ultravox.UltravoxProtocolFactory;
...
public class ShoutcastV2AudioBroadcaster extends AudioBroadcaster implements IBroadcastMetadataUpdater
{
    ...
    /**
     * Broadcasts the ua.in.smartjava.audio frame or sequence
     */
    @Override
    protected void broadcastAudio(byte[] audio)
    {
        ...
        //Dispatch ua.in.smartjava.audio ua.in.smartjava.message
     ...
     *
     * @return true if the ua.in.smartjava.audio handler can stream ua.in.smartjava.audio
     */
...
//                    new LoggingFilter(ShoutcastV2AudioBroadcaster.class));
     ...
     *
     * @param metadata containing ua.in.smartjava.audio metadata tags and attributes
    ...
    public class ShoutcastV2IOHandler extends IoHandlerAdapter
    {
        ...
        public void messageReceived(IoSession session, Object object) throws Exception
        {
            if(object instanceof UltravoxMessage)
            {
                ...
                switch(ultravoxMessage.getMessageType())
                {
                    ...
                    case STANDBY:
                        ...
                        break;
                    default:
                        mLog.error("Unrecognized ultravox ua.in.smartjava.message:" + ultravoxMessage.getMessageType() +
            ...
            {
                mLog.debug("Unrecognized ua.in.smartjava.message received from shoutcast v2 server:" + object.toString());
