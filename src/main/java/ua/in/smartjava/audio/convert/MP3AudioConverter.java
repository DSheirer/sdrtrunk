...
public class MP3AudioConverter implements IAudioConverter
{
    ...
    /**
     * Converts PCM 8kHz 16-bit Little Endian ua.in.smartjava.audio packets to Mono, Low Quality MP3 compressed ua.in.smartjava.audio.
     *
     * @param bitRate for converted MP3 ua.in.smartjava.audio
    ...
    public byte[] convert(List<AudioPacket> audioPackets)
    {
        ...
        {
            mLog.error("There was an error converting ua.in.smartjava.audio to MP3: " + e.getMessage());
            return new byte[0];
        }
    }
