 ...
 ******************************************************************************/
package ua.in.smartjava.audio.invert;

import ua.in.smartjava.audio.InversionFrequency;
import ua.in.smartjava.sample.real.RealSampleListener;
import ua.in.smartjava.dsp.filter.Filters;
import ua.in.smartjava.dsp.filter.FloatFIRFilter;
import ua.in.smartjava.dsp.mixer.Oscillator;

/**
 * Applies ua.in.smartjava.audio inversion (or un-inversion) to a broadcast of float ua.in.smartjava.audio samples
 * by multiplying each successive ua.in.smartjava.sample by either a 1 or a -1 value.
 */
public class AudioInverter implements RealSampleListener
{
    ...
    {
		//Multiply the ua.in.smartjava.sample by the folding frequency and then send it to
		//the low pass ua.in.smartjava.filter
	...
	/**
	 * Simple class to receive the output of the FIR low pass ua.in.smartjava.filter and then
