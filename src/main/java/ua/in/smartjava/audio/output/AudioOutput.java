...
import ua.in.smartjava.audio.AudioEvent;
import ua.in.smartjava.audio.AudioPacket;
import ua.in.smartjava.audio.AudioPacket.Type;
...
public abstract class AudioOutput implements Listener<AudioPacket>, LineListener
{
    ...
    /**
     * Single ua.in.smartjava.audio ua.in.smartjava.channel playback with automatic starting and stopping of the
     * underlying sourcedataline specified by the mixer and mixer ua.in.smartjava.channel
     * arguments.
     *
     * Maintains an internal non-blocking ua.in.smartjava.audio packet queue and processes this
     * queue 25 times a second (every 40 ms).
     *
     * @param mixer to obtain ua.in.smartjava.source data line
     * @param mixerChannel either mono or left/right stereo
     * @param audioFormat to use during playback
     * @param lineInfo to use when obtaining the ua.in.smartjava.source data line
     * @param requestedBufferSize of approximately 1 second of ua.in.smartjava.audio
     */
                       ...
                       int requestedBufferSize)
    {
        ...
        try
        {
            ...
            if(mOutput != null)
            {
                ...
                //Start threshold: ua.in.smartjava.buffer is full with 10% or less of capacity remaining
                mBufferStartThreshold = (int) (mOutput.getBufferSize() * 0.10);

                //Stop threshold: ua.in.smartjava.buffer is empty with 90% or more capacity available
        ...
        {
            mLog.error("Couldn't obtain ua.in.smartjava.audio ua.in.smartjava.source data line for "
                + "ua.in.smartjava.audio output - mixer [" + mMixer.getMixerInfo().getName() + "]");
        }
    }
    ...
    /**
     * Converts the ua.in.smartjava.audio packet data into a byte ua.in.smartjava.buffer format appropriate for
     * the underlying ua.in.smartjava.source data line.
     */
    protected abstract ByteBuffer convert(AudioPacket packet);

    /**
     * Audio output ua.in.smartjava.channel name
     */
    ...
    /**
     * Mixer Channel for this ua.in.smartjava.audio output
     */
    ...
    /**
     * Registers a single listener to receive ua.in.smartjava.audio start and ua.in.smartjava.audio stop events
     */
    ...
    /**
     * Broadcasts an ua.in.smartjava.audio event to the registered listener
     */
    ...
    /**
     * Registers a single listener to receive the ua.in.smartjava.audio metadata from each
     * ua.in.smartjava.audio packet
     */
    ...
    /**
     * Broadcasts ua.in.smartjava.audio metadata to the registered listener
     */
    ...
    /**
     * Timestamp of either last ua.in.smartjava.buffer received or last ua.in.smartjava.buffer processed
     */
    ...
    public void receive(AudioPacket packet)
    {
        if(mCanProcessAudio)
        {
            //Update the activity timestamp so that this ua.in.smartjava.audio output doesn't
            //get disconnected before it starts processing the ua.in.smartjava.audio stream
            updateTimestamp();
    ...
    public class BufferProcessor implements Runnable
    {
        ...
        public void run()
        {
                    ...
                    for(AudioPacket packet : packets)
                    {
                        if(packet.getType() == Type.AUDIO)
                        {
                            ...
                            if(!mOutput.isRunning())
                            {
                                ...
                                //Top off the ua.in.smartjava.buffer and check if we can start it
            ...
            {
                mLog.error("Error while processing ua.in.smartjava.audio buffers", e);
            }
        }

        /**
         * Starts ua.in.smartjava.audio playback once ua.in.smartjava.audio ua.in.smartjava.buffer is almost full and remaining
        ...
        /**
         * Stops ua.in.smartjava.audio playback and drains the ua.in.smartjava.audio ua.in.smartjava.buffer to empty when the
         * ua.in.smartjava.audio ua.in.smartjava.buffer is mostly empty and the available ua.in.smartjava.buffer capacity
    ...
    /**
     * Sets the mute state for this ua.in.smartjava.audio output ua.in.smartjava.channel
     */
    ...
    /**
     * Current mute state for this ua.in.smartjava.audio output ua.in.smartjava.channel
     */
    ...
    /**
     * Gain/volume control for this ua.in.smartjava.audio output ua.in.smartjava.channel, if one is available.
     */
    ...
    /**
     * Monitors the ua.in.smartjava.source data line playback state and broadcasts ua.in.smartjava.audio events
