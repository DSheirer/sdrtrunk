...
/**
 * Provides squelch control based on presense of decoded ua.in.smartjava.audio samples.
 * 
 * NOTE: this class is not yet fully implemented with ua.in.smartjava.audio ua.in.smartjava.sample processing
