    ...
    implements Listener<AudioEvent>, SettingChangeListener
{
    ...
    public static final String PROPERTY_PREFIX = "ua.in.smartjava.audio.ua.in.smartjava.channel.panel.color.";
    ...
    /**
     * Updates the ua.in.smartjava.alias label with text and ua.in.smartjava.icon from the ua.in.smartjava.alias.  Note: this
    ...
    /**
     * Processes ua.in.smartjava.audio metadata to update this panel's display values
     */
