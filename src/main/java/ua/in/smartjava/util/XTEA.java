...
public class XTEA
{
     ...
     *
     * Algorithm ua.in.smartjava.source code adapted from: https://people.rit.edu/rab3106/CryptoReport.pdf (as accessed Sep. 2016)
     *
    ...
    /**
     * Set the key for this block cipher. Key must be 128 ua.in.smartjava.bits or 16 bytes.  The key value can be zero padded to
    ...
    /**
     * Encrypts the plaintext argument.  Textual byte array must be 64 ua.in.smartjava.bits or 8 bytes in length and can be zero padded
