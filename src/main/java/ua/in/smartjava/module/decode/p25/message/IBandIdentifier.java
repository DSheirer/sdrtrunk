...
public interface IBandIdentifier
{
	...
	/**
	 * Downlink (tower to mobile) Frequency for the specified ua.in.smartjava.channel
	 */
	public abstract long getDownlinkFrequency(int channelNumber);

	/**
	 * Uplink (mobile to tower) Frequency for the specified ua.in.smartjava.channel
	 */
