...
public class LTRCallEvent extends CallEvent
{
	...
	/**
	 * Checks if the ua.in.smartjava.message's talkgroup matches this call event.  Counts the
	 * number of messages that match this call event to use in determining if
	 * a call event is valid or an isolated (errant) ua.in.smartjava.message.
	 * 
	 * See: isValid()
	 */
