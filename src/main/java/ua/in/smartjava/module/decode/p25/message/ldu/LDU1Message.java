...
public class LDU1Message extends LDUMessage
{
    ...
    private void checkCRC()
    {
		 ...
		 * Check the Reed-Solomon parity ua.in.smartjava.bits. The RS decoder expects the code
