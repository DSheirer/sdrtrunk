...
import ua.in.smartjava.edac.CRCFleetsync;
...
public class MPT1327Message extends Message
{
     ...
     * ua.in.smartjava.message ua.in.smartjava.bits between start and end.
     */
	 ...
	 *   [C] = corrected ua.in.smartjava.message
	 *   [-] = ua.in.smartjava.message section not present
	 */
	...
	/**
	 * Indicates if Block 1 of the ua.in.smartjava.message has passed the CRC check.
	 */
    ...
    /**
     * Constructs a decoded ua.in.smartjava.message string
     */
    @Override
    ...
    /**
     * Determines the ua.in.smartjava.message type from block 1
     */
    ...
    /**
     * Indicates if this ua.in.smartjava.message has a system identifier
     */
	...
	/**
	 * Data ua.in.smartjava.message codeword descriptor.  Indicates the type of data ua.in.smartjava.message
	...
	/**
	 * String representation of the CRC check for each 64-bit ua.in.smartjava.message block in
	 * this ua.in.smartjava.message.
	 */
	@Override
	...
	/**
	 * Used by the ua.in.smartjava.map to get a plottable version of this event
	 */
	@Override
	...
	/**
	 * Indicates the number of data codeword slots appended to a HEAD ua.in.smartjava.message
	 */
	public enum Slots
	{
		SLOTS_0( "RESERVED" ),
