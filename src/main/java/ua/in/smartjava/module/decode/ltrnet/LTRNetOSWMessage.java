...
public class LTRNetOSWMessage extends LTRNetMessage
{
	...
	/**
	 * Returns the value of the high order (15 - 12) frequency ua.in.smartjava.bits which are
	 * the lower 4 ua.in.smartjava.bits of the Free field, left shifted by 12, representing the
	...
	/**
	 * Returns the value of the low order (11 - 0) frequency ua.in.smartjava.bits which are
