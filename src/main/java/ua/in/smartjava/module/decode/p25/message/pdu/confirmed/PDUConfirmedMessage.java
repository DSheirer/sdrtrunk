...
import ua.in.smartjava.module.decode.p25.reference.PDUType;
...
public class PDUConfirmedMessage extends PDUMessage
{
	...
	/**
	 * Constructor to support subclassing of this ua.in.smartjava.message.  Initial construction
	 * of the ua.in.smartjava.message enables CRC checks to be calculated and ua.in.smartjava.message type to
	 * be inspected so that we can construct an accurate subclass ua.in.smartjava.message,
	...
	/**
	 * Number of bytes/octets contained in the ua.in.smartjava.message, exclusive of the data
	 * header.
	 */
