...
import ua.in.smartjava.instrument.tap.stream.AdditiveFloatTap;
...
import ua.in.smartjava.sample.real.RealSampleProvider;
...
import ua.in.smartjava.dsp.gain.DirectGainControl;
...
//	private static final double COARSE_FREQUENCY_DEADBAND = 1.66;
	 ...
	 * C4FM Symbol Filter
	 * 
	 * Sample Gain values - the gain of incoming ua.in.smartjava.sample values will critically
	 * impact the performance of this ua.in.smartjava.filter.  Gain should be adjusted to
	 ...
	 * setting for this ua.in.smartjava.filter is 15.4 and that yields a symbol spread that
...
//		mFrequencyCorrectionControl = null;
	...
	public void receive( RealBuffer buffer )
	{
		 ...
		 * ua.in.smartjava.buffer, we'll apply the change and it will be reflected in the next
		 * arriving ua.in.smartjava.buffer.  Reset the lock on frequency correction and reset
    ...
    public void receive( float sample )
    {
		...
		if( mSymbolClock > 1.0f )
		{
			...
			/* Queue a frequency adjustment (once per ua.in.smartjava.buffer) as needed */
	...
	/**
	 * Receives notifications that the ua.in.smartjava.channel frequency correction has been
