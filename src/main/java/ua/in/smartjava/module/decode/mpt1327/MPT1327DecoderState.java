...
import ua.in.smartjava.module.decode.mpt1327.MPT1327Message.IdentType;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import ua.in.smartjava.util.StringUtils;
...
public class MPT1327DecoderState extends DecoderState
{
            ...
            if(message instanceof MPT1327Message)
            {
                ...
                switch(mpt.getMessageType())
                {
                    ...
                    case MAINT:
                        ...
                        {
                            /**
                             * When we receive a MAINT ua.in.smartjava.message and we're configured
                             * as a standard ua.in.smartjava.channel, we need to apply the call
    ...
    private void resetState()
    {
        ...
        /**
         * If this is a standard ua.in.smartjava.channel, reset the fade timeout to the default
         * timeout.  Once processing is underway, if we get a MAINT ua.in.smartjava.message,
         * this indicates we're processing a traffic ua.in.smartjava.channel as a standard
         * ua.in.smartjava.channel, so we'll issue a different call timeout then.
         */
        if(mChannelType == ChannelType.STANDARD)
        {
    ...
    /**
     * Set the ua.in.smartjava.channel number.  This is used primarily for traffic channels since
     * the ua.in.smartjava.channel will already have been identified prior to the traffic
     * ua.in.smartjava.channel being created.
     */
                ...
                if(event.getSource() != MPT1327DecoderState.this)
                {
                    if(event instanceof TrafficChannelAllocationEvent)
                    {
                        ...
                        if(channel != null)
                        {
                            ...
                            {
                                //Do nothing, we couldn't parse the ua.in.smartjava.channel number
                            }
                        }
