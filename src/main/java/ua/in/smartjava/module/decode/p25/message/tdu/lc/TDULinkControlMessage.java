...
import ua.in.smartjava.module.decode.p25.reference.VendorLinkControlOpcode;
...
import ua.in.smartjava.edac.Golay24;
import ua.in.smartjava.edac.ReedSolomon_63_47_17;
...
public class TDULinkControlMessage extends P25Message
{
            ...
            AliasList aliasList )
    {
	    ...
	    /* NID CRC is checked in the ua.in.smartjava.message framer so a constructed ua.in.smartjava.message
	...
	/**
	 * Constructs a TDULinkControl ua.in.smartjava.message from an existing ua.in.smartjava.message and bypasses
	 * the CRC calculation.
	 */
	...
	/**
	 * If the vendor is motorola, returns the Motorola OPCODE for this ua.in.smartjava.message
	 */
	...
	private void checkCRC()
	{
		...
		/* Check the Reed-Solomon parity ua.in.smartjava.bits. The RS decoder expects the link
	...
	/**
	 * Indicates if the ua.in.smartjava.message passed the golay and reed-solomon parity checks
	 * or was corrected.
	 */
	public boolean isValid()
	{
		// mCRC[ 0 ] - always passes (otherwise ua.in.smartjava.message wouldn't be constructed )
