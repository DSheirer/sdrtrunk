...
/**
 * MPT1327 Decoder - 1200 baud 2FSK decoder that can process 48k ua.in.smartjava.sample rate
...
public class MPT1327Decoder extends Decoder implements IFilteredRealBufferListener, Instrumentable
{
    ...
    static
    {
        ...
        {
            mLog.error("Couldn't design MPT1327 highpass ua.in.smartjava.filter");
        }
    }
    ...
    /* Message length -- longest possible ua.in.smartjava.message is:
    ...
    public MPT1327Decoder(AliasList aliasList, Sync sync)
    {
        ...
        /* Decimation ua.in.smartjava.filter - 48000 / 2 = 24000 output */
        mDecimationFilter = new HalfBandFilter_RB_RB(Filters.FIR_HALF_BAND_31T_ONE_EIGHTH_FCO.getCoefficients(), 1.0002f, true);

        //High-pass ua.in.smartjava.filter the ua.in.smartjava.audio to remove any DC component or CTCSS tones. The ua.in.smartjava.audio has already been low-pass
        //filtered by the AudioDemodulation ua.in.smartjava.filter cutoff of 3400 Hz.
        ...
        /* Message framer for control ua.in.smartjava.channel messages */
        ...
        /* Message framer for traffic ua.in.smartjava.channel massages */
