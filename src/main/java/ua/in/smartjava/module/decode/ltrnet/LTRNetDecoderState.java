...
import ua.in.smartjava.channel.metadata.AliasedIntegerAttributeMonitor;
...
public class LTRNetDecoderState extends DecoderState
{
            ...
            if(message instanceof LTRNetOSWMessage)
            {
                ...
                switch(ltr.getMessageType())
                {
                    ...
                    case CA_STRT:
						...
						/* If the call event ua.in.smartjava.channel matches our current ua.in.smartjava.channel
    ...
    /**
     * Call Detect - current ua.in.smartjava.channel messages indicate a call on another ua.in.smartjava.channel
     */
