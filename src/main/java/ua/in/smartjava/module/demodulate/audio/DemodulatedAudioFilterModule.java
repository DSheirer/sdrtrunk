 ...
 *
 ******************************************************************************/
package ua.in.smartjava.module.demodulate.audio;

import ua.in.smartjava.dsp.filter.FilterFactory;
import ua.in.smartjava.dsp.filter.Window.WindowType;
import ua.in.smartjava.dsp.filter.dc.DCRemovalFilter_RealBuffer;
...
public class DemodulatedAudioFilterModule extends Module implements IUnFilteredRealBufferListener, IFilteredRealBufferProvider
{
    ...
    /**
     * Filters demodulated ua.in.smartjava.audio and removes any DC component from the ua.in.smartjava.buffer
     *
     * @param pass - ua.in.smartjava.audio pass band pass frequency
     * @param stop - ua.in.smartjava.audio pass band stop frequency
     */
    public DemodulatedAudioFilterModule(int pass, int stop)
    {
        ...
        //TODO: change this to a band pass ua.in.smartjava.filter
    ...
    /**
     * Constructs a demodulated ua.in.smartjava.audio ua.in.smartjava.filter using the ua.in.smartjava.filter taps and gain provided
     */
