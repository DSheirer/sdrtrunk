 ...
 ******************************************************************************/
package ua.in.smartjava.module.demodulate.fm;
...
import ua.in.smartjava.dsp.fm.FMDemodulator_CB;
...
public class FMDemodulatorModule extends Module implements IComplexBufferListener, IUnFilteredRealBufferProvider
{
    ...
    /**
     * FM Demodulator with I/Q ua.in.smartjava.filter.  Demodulated output is unfiltered and
