...
public class FloatCircularBuffer
{
	...
	/**
	 * Convenience method to put a new value in the ua.in.smartjava.buffer, while discarding
	 * the old value
	 */
	 ...
	 * @param sampleCount - number of the oldest samples in the ua.in.smartjava.buffer to load
	 * @return
	 */
