...
{
    //Hamming error values indicating the number of ua.in.smartjava.bits set in each indexed value, 0-15
     ...
     * where the ua.in.smartjava.bits represent the dibit pair for the constellation point.
     */
