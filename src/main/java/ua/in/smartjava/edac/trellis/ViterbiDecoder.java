...
public abstract class ViterbiDecoder
{
    ...
    /**
     * Size in ua.in.smartjava.bits of the input and state values (e.g. 3/4 rate input size is 3)
     *
    ...
    /**
     * Size in ua.in.smartjava.bits of the output constellation or transmitted symbol value (e.g. 3/4 rate output size is 4)
     *
     * @return output size in ua.in.smartjava.bits
     */
     ...
     * sequence of nodes.
     *
     * @param transmittedOutputValues from the encoded ua.in.smartjava.message
