...
public class CRCP25
{
	...
	/**
	 * CRC-CCITT 16-bit checksums for a ua.in.smartjava.message length of 80 ua.in.smartjava.bits plus 16
	 ...
	 * data blocks of a PDU1 ua.in.smartjava.message.
	 */
	...
	/**
	 * Performs error detection and single-bit error correction against the
	 * data blocks of a PDU2 ua.in.smartjava.message.
	 */
	...
	/**
	 * Performs error detection and single-bit error correction against the
	 * data blocks of a PDU3 ua.in.smartjava.message.
	 */
	 ...
	 * is located between ua.in.smartjava.bits 7-15, within a 144 bit block.  The checksums
	 * were generated assuming that the ua.in.smartjava.message is contiguous from 0 - 134 ua.in.smartjava.bits.
	...
	public static CRC checkCRC9( BinaryMessage message, int messageStart )
	{
		...
		for (int i = message.nextSetBit( messageStart ); 
				 ...
				 i = message.nextSetBit( i+1 ) ) 
		{
			/* ua.in.smartjava.message ua.in.smartjava.bits before the CRC */
			if( i < ( messageStart + 7 ) )
			{
				calculated ^= CRC9_CHECKSUMS[ i - messageStart ];
			}
			/* ua.in.smartjava.message ua.in.smartjava.bits after the CRC */
...
//		mLog.debug( "CALC:" + calculated + " CHECK:" + checksum + " RESID:" + residual );
	 ...
	 * encoded 24-bit ua.in.smartjava.message segments following the 64-bit NID in the ua.in.smartjava.message
	 * 
	 * @return - true if all 12 segments of the ua.in.smartjava.message can be checked/corrected
	 */
	...
	/**
	 * Calculates the value of the ua.in.smartjava.message checksum as a long
	 */
	...
	/**
	 * Calculates the value of the ua.in.smartjava.message checksum as an integer
	 */
