 ...
 * 
 * Fleetsync ua.in.smartjava.message blocks are 64 ua.in.smartjava.bits in length as follows:
 * 	  0 - 47: ua.in.smartjava.message ua.in.smartjava.bits
 *   48 - 62: CRC-15 check ua.in.smartjava.bits
 *        63: even parity bit
 *        
...
public class CRCFleetsync
{
	...
	/**
	 * Determines if ua.in.smartjava.message ua.in.smartjava.bits 0 - 47 pass the Fleetsync CRC checksum
	 * contained in ua.in.smartjava.bits 48 - 63, using a lookup table of CRC checksum values
	 * derived from the CRC-15 value, and verifies the ua.in.smartjava.message has even parity
	 */
     ...
     * @return - array of integer positions of ua.in.smartjava.bits that need flipped
     */
    public static int[] findBitErrors( BitSet msg )
    {
		...
		//Iterate set ua.in.smartjava.message ua.in.smartjava.bits, removing their respective checksum value
