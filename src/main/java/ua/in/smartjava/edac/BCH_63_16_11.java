...
public class BCH_63_16_11 extends BerlekempMassey_63
{
	...
	/**
	 * Performs error detection and correction on the first 63 ua.in.smartjava.bits of the
	 * ua.in.smartjava.message argument.  If the ua.in.smartjava.message is correctable, only the first 16 ua.in.smartjava.bits
	 * (information ua.in.smartjava.bits) are corrected.
	 * 
