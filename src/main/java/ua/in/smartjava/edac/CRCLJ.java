 ...
 * 
 * LJ ua.in.smartjava.message blocks are 80 ua.in.smartjava.bits in length as follows:
 *    0 -  7: Bit reversals
 *    8 - 15: Sync pattern
 *   16 - 23: VRC
 *   24 - 31: LRC
...
public class CRCLJ
{
	...
	/**
	 * Determines if FUNCTION AND ADDRESS ua.in.smartjava.bits pass the LJ CRC checksum
