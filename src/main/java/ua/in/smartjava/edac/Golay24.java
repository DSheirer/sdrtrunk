...
public class Golay24
{
	 ...
	 * ua.in.smartjava.message that starts at the start index.
	 * @param message - ua.in.smartjava.source ua.in.smartjava.message containing startIndex + 24 ua.in.smartjava.bits length
	...
	public static BinaryMessage checkAndCorrect( BinaryMessage message, int startIndex )
	{
		...
		/* Get original ua.in.smartjava.message value */
