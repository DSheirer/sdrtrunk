...
public class CRCUtil
{
	...
	/* Determines the parity (number of 1 ua.in.smartjava.bits) for the value */
	...
	/**
	 * Performs binary division of the polynomial into the ua.in.smartjava.message for ua.in.smartjava.bits
	 * in index 0 to index messageLength - 1, leaving the results in the
	 * checksum filed following the ua.in.smartjava.message.
	 * 
	 ...
	 * R: Remainder
	 * 
	 * @param message - ua.in.smartjava.message and crc
	 * @param polynomial - crc polynomial - must be 1 bit longer than the crc width
	 * @param messageSize - ua.in.smartjava.message length and start of the checksum
	 * 
	 * @return ua.in.smartjava.message with all ua.in.smartjava.message ua.in.smartjava.bits zeroed out, and the remainder
...
//		BitSetBuffer ua.in.smartjava.message = BitSetBuffer.load( raw );
//		
//		long polynomial = 0x259l;
//
//		decode( ua.in.smartjava.message, 0, 135, polynomial, 9 );
//
//		mLog.debug( ua.in.smartjava.message.toString() );
