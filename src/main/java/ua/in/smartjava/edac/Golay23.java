...
public class Golay23
{
	 ...
	 * the max correctable errors (3), then the error ua.in.smartjava.bits are corrected.
	 * Otherwise the ua.in.smartjava.message is left intact and an error count greater than 3
	 * is returned.
	 * 
	 * @param frame - ua.in.smartjava.message frame bitset
