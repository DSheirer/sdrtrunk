 ...
 * 
 * Note: works for sync patterns up to 63 ua.in.smartjava.bits (integer size - 1 ) long.
...
public class MultiSyncPatternMatcher
{
	...
	/**
	 * Processes two ua.in.smartjava.bits before checking sync processors for a match.
	 */
