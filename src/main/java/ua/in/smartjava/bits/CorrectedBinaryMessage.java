...
public class CorrectedBinaryMessage extends BinaryMessage
{
    ...
    /**
     * Subclass of binary ua.in.smartjava.message class to allow capturing a corrected ua.in.smartjava.bits metric.
     * @param size of ua.in.smartjava.message to create.
     */
    ...
    /**
     * Sets the number of ua.in.smartjava.bits that were corrected in this ua.in.smartjava.message
     * @param count of corrected ua.in.smartjava.bits
     */
