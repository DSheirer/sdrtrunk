...
public class ChannelMapModel extends AbstractListModel<ChannelMap>
{
    ...
    /**
     * Returns an unmodifiable list of ua.in.smartjava.channel maps currently in the model
     */
    ...
    /**
     * Returns the ua.in.smartjava.channel ua.in.smartjava.map with a matching name or null
     */
    ...
    /**
     * Adds a listener to receive notifications when ua.in.smartjava.channel ua.in.smartjava.map updates occur
     */
    ...
    /**
     * Removes the ua.in.smartjava.channel ua.in.smartjava.map update notification listener
     */
    ...
    /**
     * Broadcasts a ua.in.smartjava.channel ua.in.smartjava.map change.
     *
     * Note: use the add/remove methods to add or remove ua.in.smartjava.channel maps from this
    ...
    /**
     * Adds a list of ua.in.smartjava.channel maps to this model
     */
    ...
    /**
     * Adds the ua.in.smartjava.channel ua.in.smartjava.map to this model
     */
    ...
    /**
     * Removes the ua.in.smartjava.channel ua.in.smartjava.map from this model
     */
    ...
    /**
     * Size/Number of ua.in.smartjava.channel maps in this model
     */
    @Override
    public int getSize()
    {
    ...
    /**
     * Returns the ua.in.smartjava.channel ua.in.smartjava.map at the specified index
     */
    @Override
