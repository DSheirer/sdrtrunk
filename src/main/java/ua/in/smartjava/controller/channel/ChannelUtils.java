...
import ua.in.smartjava.module.decode.event.ActivitySummaryFrame;
...
{
	/**
	 * Creates a context menu for the ua.in.smartjava.channel argument
	 */
			...
			deleteItem.addActionListener( new ActionListener() 
			{
	            ...
	            public void actionPerformed( ActionEvent e )
	            {
					int response = JOptionPane.showConfirmDialog( anchor, 
						"Do you want to delete ua.in.smartjava.channel " + channel.getName() + "?",
