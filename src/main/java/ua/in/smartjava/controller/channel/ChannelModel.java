...
public class ChannelModel extends AbstractTableModel implements IChannelEventBroadcaster
{
    ...
    /**
     * Returns the ua.in.smartjava.channel identified by the id argument
     */
    ...
    /**
     * Returns a list of unique system values from across the ua.in.smartjava.channel set
     */
    ...
    /**
     * Broadcasts the ua.in.smartjava.channel event to all registered listeners
     */
    @Override
    ...
    /**
     * Bulk loading of ua.in.smartjava.channel list.  Each ua.in.smartjava.channel is added and a ua.in.smartjava.channel add
     * event is broadcast.
     */
    ...
    /**
     * Adds the ua.in.smartjava.channel to the model and broadcasts a ua.in.smartjava.channel add event
     */
