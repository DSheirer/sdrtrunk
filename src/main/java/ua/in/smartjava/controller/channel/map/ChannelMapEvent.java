...
public class ChannelMapEvent
{
	...
	/**
	 * ChannelMapEvent - event describing any changes to a ua.in.smartjava.channel ua.in.smartjava.map
	 * 
	...
	/**
	 * ChannelMapEvent - ua.in.smartjava.channel ua.in.smartjava.map renaming event.
	 * 
	 * @param channelMap that changed
	 * @param previousName of the ua.in.smartjava.channel ua.in.smartjava.map
	 */
