				...
				implements ActionListener, ListSelectionListener
{
	...
	private void init()
	{
    	...
    	mNewChannelButton.setToolTipText( "Create a new ua.in.smartjava.channel configuration" );
    	buttonsPanel.add( mNewChannelButton );
    	
    	mCopyChannelButton.addActionListener( this );
    	mCopyChannelButton.setEnabled( false );
    	mCopyChannelButton.setToolTipText( "Create a copy of the currently selected ua.in.smartjava.channel configuration" );
    	buttonsPanel.add( mCopyChannelButton );

    	mDeleteChannelButton.addActionListener( this );
    	mDeleteChannelButton.setEnabled( false );
    	mDeleteChannelButton.setToolTipText( "Delete the currently selected ua.in.smartjava.channel configuration" );
	...
	/**
	 * Adds the ua.in.smartjava.channel to the ua.in.smartjava.channel model/table and scrolls to view it
	 */
			...
			case DELETE_CHANNEL:
				...
				if( toDelete != null )
				{
					int choice = JOptionPane.showConfirmDialog( ChannelController.this, 
						"Do you want to delete this ua.in.smartjava.channel?", "Delete Channel?",
