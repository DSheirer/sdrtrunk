package ua.in.smartjava.gui.control;
...
import ua.in.smartjava.buffer.CircularBuffer;
...
public class ConstellationViewer extends JPanel implements Listener<Complex>
{
	 ...
	 * ua.in.smartjava.sample to plot, within the symbol timeframe.  Values greater than the
