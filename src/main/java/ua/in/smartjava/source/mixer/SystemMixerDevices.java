...
public class SystemMixerDevices {
	 ...
	 * ua.in.smartjava.audio format argument
	 * 
	 * @param format - requested ua.in.smartjava.audio format
	 * @return - mixer target data lines that support the requested ua.in.smartjava.audio format
	 */
	public static HashMap<String,TargetDataLine> getMixers( AudioFormat format )
	{
        ...
        for( Mixer.Info mixerInfo: AudioSystem.getMixerInfo() )
        {
            ...
            if( mixer != null )
            {
                ...
                {
                    //Do nothing ... mixer doesn't support the ua.in.smartjava.audio format
                }
