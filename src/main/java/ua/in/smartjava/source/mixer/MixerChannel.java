...
public enum MixerChannel
{
	...
	/**
	 * Mixer Target Data Line (ie ua.in.smartjava.sample ua.in.smartjava.source) ua.in.smartjava.channel options
	 */
	...
	/**
	 * Mixer Source Data Line (ie sound card output) ua.in.smartjava.channel options
	 */
