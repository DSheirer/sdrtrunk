...
import ua.in.smartjava.sample.adapter.ChannelShortAdapter;
import ua.in.smartjava.sample.adapter.ShortAdapter;
import ua.in.smartjava.source.config.SourceConfigMixer;
...
public class MixerManager
{
						...
						if( channel == MixerChannel.MONO )
						{
                            ...
                            catch ( LineUnavailableException e )
                            {
	                            mLog.error( "couldn't get mixer data line " +
	                            		"for [" + mixerName + "] for ua.in.smartjava.channel [" +
	                            		channel.name() + "]", e );
                            }
	...
	/**
	 * Returns enumset of SourceDataLine (ua.in.smartjava.audio output) channels
	 * (MONO and/or STEREO) supported by the mixer, or null if the mixer doesn't 
	 * have any ua.in.smartjava.source data lines.
	 */
