...
/**
 * Interface for broadcasting changes to frequency, bandwidth, ua.in.smartjava.sample rate,
 * and actual ua.in.smartjava.sample rate values to all registered listeners.
 * 
