...
import ua.in.smartjava.sample.complex.ComplexSampleListListener;
import ua.in.smartjava.source.mixer.ComplexMixer;
...
public abstract class MixerTuner extends Tuner implements Listener<ComplexBuffer>
{
	 ...
	 * Subclasses should couple this functionality with a tuner ua.in.smartjava.controller class
	 * to support tuning.
	 */
	 ...
	 * starting the ua.in.smartjava.buffer processing thread
	 */
	@Override
	...
	/**
	 * Overrides the parent Tuner class listener management method to allow
	 * stopping the ua.in.smartjava.buffer processing thread when there are no more listeners
	 */
	@Override
