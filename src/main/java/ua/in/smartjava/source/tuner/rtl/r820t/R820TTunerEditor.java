 ...
 ******************************************************************************/
package ua.in.smartjava.source.tuner.rtl.r820t;
...
import ua.in.smartjava.source.tuner.configuration.TunerConfigurationEditor;
import ua.in.smartjava.source.tuner.configuration.TunerConfigurationEvent;
import ua.in.smartjava.source.tuner.configuration.TunerConfigurationEvent.Event;
...
import ua.in.smartjava.source.tuner.rtl.RTL2832TunerController.Descriptor;
import ua.in.smartjava.source.tuner.rtl.RTL2832TunerController.SampleRate;
import ua.in.smartjava.source.tuner.rtl.r820t.R820TTunerController.R820TGain;
import ua.in.smartjava.source.tuner.rtl.r820t.R820TTunerController.R820TLNAGain;
import ua.in.smartjava.source.tuner.rtl.r820t.R820TTunerController.R820TMixerGain;
import ua.in.smartjava.source.tuner.rtl.r820t.R820TTunerController.R820TVGAGain;
            ...
            public void actionPerformed( ActionEvent e )
            {
                ...
                catch ( SourceException | LibUsbException eSampleRate )
                {
                	JOptionPane.showMessageDialog( 
                			...
                			"R820T Tuner Controller - couldn't apply the ua.in.smartjava.sample "
                			+ "rate setting [" + sampleRate.getLabel() + "] " + 
                					eSampleRate.getLocalizedMessage() );  
                	
                	mLog.error( "R820T Tuner Controller - couldn't apply ua.in.smartjava.sample "
                			+ "rate setting [" + sampleRate.getLabel() + "]", 
                			eSampleRate );
                }
            }
