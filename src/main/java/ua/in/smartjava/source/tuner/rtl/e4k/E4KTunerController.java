 ...
 ******************************************************************************/
package ua.in.smartjava.source.tuner.rtl.e4k;
...
import ua.in.smartjava.source.tuner.rtl.RTL2832TunerController;
...
public class E4KTunerController extends RTL2832TunerController
{
    ...
    public E4KTunerController(Device device, DeviceDescriptor deviceDescriptor) throws SourceException
    {
        super(device, deviceDescriptor, MIN_FREQUENCY, MAX_FREQUENCY, DC_SPIKE_AVOID_BUFFER, USABLE_BANDWIDTH_PERCENT);
    }
    ...
    /**
     * Sets the IF filters (mixer, ua.in.smartjava.channel and RC) to the correct ua.in.smartjava.filter setting
     * for the selected bandwidth/ua.in.smartjava.sample rate
     */
    @Override
    ...
    public long getTunedFrequency() throws SourceException
    {
        ...
        {
            throw new SourceException("E4K tuner ua.in.smartjava.controller - couldn't get "
                + "tuned frequency", e);
        }
    }
    ...
    public void setTunedFrequency(long frequency) throws SourceException
    {
        ...
        try
        {
			...
			/* Set the ua.in.smartjava.filter */
            ...
            if(!((lock & 0x1) == 0x1))
            {
                throw new SourceException("E4K tuner ua.in.smartjava.controller - couldn't "
        ...
        {
            throw new SourceException("E4K tuner ua.in.smartjava.controller - error tuning "
...
//								i2CRepeaterControl );
		...
		/* Set the most narrow ua.in.smartjava.filter we can possible use */
...
//		setDCRangeDetectorEnabled( false, i2CRepeaterControl );
     ...
     * to configure ua.in.smartjava.gui components to expose the individual Mixer, LNA and
     ...
     * the ua.in.smartjava.filter and the applicable frequency minimums and maximums for the
    ...
    public enum RFFilter
    {
		 ...
		 * and we set the max frequency for this ua.in.smartjava.filter to 2147 MHz */
        ...
        /**
         * Minimum frequency for this ua.in.smartjava.filter.
         */
        ...
        /**
         * Maximum frequency for this ua.in.smartjava.filter is less than this value, but does
        ...
        /**
         * Selects the appropriate ua.in.smartjava.filter for the frequency
         *
         * @param frequency
         * @return selected ua.in.smartjava.filter
        ...
        public static RFFilter fromFrequency(long frequency)
        {
            ...
            throw new IllegalArgumentException("E4KTunerController - "
                + "cannot find RF ua.in.smartjava.filter for frequency [" + frequency + "]");
        }
    }
    ...
    public enum MixerFilter
    {
        ...
        /**
         * Returns the correct ua.in.smartjava.filter to use for the bandwidth/ua.in.smartjava.sample rate
         *
         * @param bandwidth - current ua.in.smartjava.sample rate
         * @return - correct ua.in.smartjava.filter to use for the bandwidth/ua.in.smartjava.sample rate
         */
        ...
        public static MixerFilter fromRegisterValue(int registerValue)
        {
            ...
            throw new IllegalArgumentException("E4KTunerController - "
                + "unrecognized mixer ua.in.smartjava.filter value [" + value + "]");
        }
    }
    ...
    public enum RCFilter
    {
        ...
        public static RCFilter fromRegisterValue(int registerValue)
        {
            ...
            throw new IllegalArgumentException("E4KTunerController - "
                + "unrecognized rc ua.in.smartjava.filter value [" + value + "]");
        }
    }
    ...
    public enum ChannelFilter
    {
        ...
        public static ChannelFilter fromRegisterValue(int registerValue)
        {
            ...
            throw new IllegalArgumentException("E4KTunerController - "
                + "unrecognized ua.in.smartjava.channel ua.in.smartjava.filter value [" + value + "]");
        }
    }
