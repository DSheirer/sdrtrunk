...
import ua.in.smartjava.source.tuner.rtl.e4k.E4KTunerController.E4KEnhanceGain;
import ua.in.smartjava.source.tuner.rtl.e4k.E4KTunerController.E4KGain;
import ua.in.smartjava.source.tuner.rtl.e4k.E4KTunerController.E4KLNAGain;
import ua.in.smartjava.source.tuner.rtl.e4k.E4KTunerController.E4KMixerGain;
            ...
            public void actionPerformed( ActionEvent e )
            {
                ...
                catch ( SourceException | LibUsbException eSampleRate )
                {
                	JOptionPane.showMessageDialog( E4KTunerEditor.this, 
            			"E4K Tuner Controller - couldn't apply the ua.in.smartjava.sample rate setting [" +
    					sampleRate.getLabel() + "] " + eSampleRate.getLocalizedMessage() );  
                	
                	mLog.error( "E4K Tuner Controller - couldn't apply ua.in.smartjava.sample rate setting [" +
