...
import ua.in.smartjava.source.tuner.airspy.AirspyTunerController.Gain;
import ua.in.smartjava.source.tuner.airspy.AirspyTunerController.GainMode;
			...
			public void actionPerformed( ActionEvent e )
			{
				...
				catch ( LibUsbException | UsbException | SourceException e1 )
				{
					JOptionPane.showMessageDialog( AirspyTunerEditor.this, 
						"Couldn't set ua.in.smartjava.sample rate to " + rate.getLabel() );
					
					mLog.error( "Error setting airspy ua.in.smartjava.sample rate", e1 );
				} 
			}
		} );
