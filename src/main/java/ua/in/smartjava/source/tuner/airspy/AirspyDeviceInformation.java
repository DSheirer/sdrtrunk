...
public class AirspyDeviceInformation
{
	...
	public void setPartAndSerialNumber( byte[] data )
	{
		if( data != null && data.length == 24 )
		{
			...
			//Note: current airspy library only exposes 64-ua.in.smartjava.bits of serial number
			//address space, but appears to have room for 128-ua.in.smartjava.bits.  We won't
			//add the first 64 ua.in.smartjava.bits if it's zeros
