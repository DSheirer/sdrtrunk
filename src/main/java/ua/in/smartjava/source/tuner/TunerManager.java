...
import ua.in.smartjava.source.tuner.airspy.AirspyTunerController;
import ua.in.smartjava.source.tuner.fcd.FCDTuner;
import ua.in.smartjava.source.tuner.fcd.proV1.FCD1TunerController;
import ua.in.smartjava.source.tuner.fcd.proplusV2.FCD2TunerController;
...
import ua.in.smartjava.source.tuner.rtl.e4k.E4KTunerController;
import ua.in.smartjava.source.tuner.rtl.r820t.R820TTunerController;
...
public class TunerManager
{
                                            ...
                                            DeviceDescriptor descriptor)
    {
        ...
        {
            mLog.error("couldn't construct Airspy ua.in.smartjava.controller/tuner", se);

            return new TunerInitStatus(null,
                "error constructing Airspy tuner ua.in.smartjava.controller");
        }
    }
                                            ...
                                            DeviceDescriptor descriptor)
    {
        ...
        {
            mLog.error("couldn't construct HackRF ua.in.smartjava.controller/tuner", se);

            return new TunerInitStatus(null,
                "error constructing HackRF tuner ua.in.smartjava.controller");
        }
    }
                                             ...
                                             DeviceDescriptor deviceDescriptor)
    {
        ...
        switch(tunerType)
        {
            case ELONICS_E4000:
                ...
                {
                    return new TunerInitStatus(null, "Error constructing E4K tuner ua.in.smartjava.controller - " +
            ...
            case RAFAELMICRO_R820T:
                ...
                catch(SourceException se)
                {
                    ...
                    return new TunerInitStatus(null, "Error constructing R820T "
                        + "tuner ua.in.smartjava.controller - " + se.getLocalizedMessage());
                }
