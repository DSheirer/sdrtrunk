 ...
 ******************************************************************************/
package ua.in.smartjava.source.tuner.fcd.proV1;
...
import ua.in.smartjava.source.tuner.MixerTunerType;
...
import ua.in.smartjava.source.tuner.fcd.FCDCommand;
import ua.in.smartjava.source.tuner.fcd.FCDTunerController;
...
public class FCD1TunerController extends FCDTunerController
{
            ...
            throws SourceException
    {
		...
		{
			//Re-cast any usb exceptions as ua.in.smartjava.source exceptions
	...
	/**
	 * Gets the current LNA Gain value from the ua.in.smartjava.controller and stores it
	 */
	...
	/**
	 * Sets lna gain for the ua.in.smartjava.controller
	 * @param gain
	 * @throws UsbException
	 ...
	 * @throws UsbClaimException - if cannot claim the FCD HID ua.in.smartjava.controller
	 ...
	 * 16 ua.in.smartjava.bits and the UNSIGNED gain value in the second 16 ua.in.smartjava.bits, both in
	 * big-endian format.  Since we're sending the argument in java little endian
	 * format, we place the phase in the high-order ua.in.smartjava.bits and the gain in the
	 * low-order ua.in.smartjava.bits, so that the send(command) function will reorder the bytes
													...
													UsbException
	{
		...
		//Left shift gain to place value in upper 16 ua.in.smartjava.bits
													...
													UsbException
	{
		...
		/**
		 * Gain: mask the upper 16 phase ua.in.smartjava.bits and right shift to get the
		...
		/**
		 * Phase: mask the lower 16 ua.in.smartjava.bits and divide by 32768 to get the double
		 * value
		 */
	 ...
	 * to the FCD ua.in.smartjava.controller
	 ...
	 * new value to the FCD ua.in.smartjava.controller
	 ...
	 * first 16 ua.in.smartjava.bits and the signed quadrature value in the second 16 ua.in.smartjava.bits,
	 * both in big-endian format.  
	 * 
	 * Since we're sending the argument in java little endian format, we place 
	 * the quadrature in the high-order ua.in.smartjava.bits and the inphase in the low-order
	 * ua.in.smartjava.bits, so that the send(command) function will reorder the bytes into big
	...
	private void setDCIQCorrection() throws UsbClaimException, UsbException
	{
		...
		//Left shift quadrature to place value in upper 16 ua.in.smartjava.bits
...
//				" correction:" + correction );
													...
													UsbException
	{
		...
		/**
		 * Quadrature: mask the upper 16 ua.in.smartjava.bits and divide by 32768 to get the
		...
		/**
		 * InPhase: mask the lower 16 ua.in.smartjava.bits to get the short
