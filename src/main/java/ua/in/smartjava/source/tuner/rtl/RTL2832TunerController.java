...
import ua.in.smartjava.sample.adapter.ByteSampleAdapter;
...
import ua.in.smartjava.source.tuner.TunerManager;
...
public abstract class RTL2832TunerController extends TunerController
{
    ...
    /**
     * Abstract tuner ua.in.smartjava.controller device.  Use the static getTunerClass() method
     * to determine the tuner type, and construct the corresponding child
     * tuner ua.in.smartjava.controller class for that tuner type.
     */
    ...
    public void init() throws SourceException
    {
        ...
        catch(Exception e)
        {
            throw new SourceException("RTL2832 Tuner Controller - couldn't "
                + "set default ua.in.smartjava.sample rate", e);
        }
    ...
    public static void initBaseband(DeviceHandle handle) throws LibUsbException
    {
		...
		/* Disable ua.in.smartjava.spectrum inversion and adjacent ua.in.smartjava.channel rejection */
		...
		/* Disable PID ua.in.smartjava.filter */
     ...
     * @param bitMask - bit mask with one for targeted register ua.in.smartjava.bits and zero
     * for the non-targeted register ua.in.smartjava.bits
                                     ...
                                     boolean enabled) throws LibUsbException
    {
        ...
        //Update the masked ua.in.smartjava.bits
        if(enabled)
        {
            value |= bitMask;
        }
                                             ...
                                             int length) throws LibUsbException
    {
        ...
        else
        {
            throw new IllegalArgumentException("Cannot write value greater "
                + "than 16 ua.in.smartjava.bits to the register - length [" + length + "]");
        }
    ...
    public int getSampleRateFromTuner() throws SourceException
    {
        ...
        catch(Exception e)
        {
            throw new SourceException("RTL2832 Tuner Controller - cannot get "
                + "current ua.in.smartjava.sample rate", e);
        }
    ...
    {
		/* Write high-order 16-ua.in.smartjava.bits of ua.in.smartjava.sample rate ratio to demod register */
        writeDemodRegister(mDeviceHandle, Page.ONE, (short) 0x9F,
            sampleRate.getRatioHighBits(), 2);
		
		/* Write low-order 16-ua.in.smartjava.bits of ua.in.smartjava.sample rate ratio to demod register.
		...
		/* Set ua.in.smartjava.sample rate correction to 0 */
		...
		/* Apply any tuner specific ua.in.smartjava.sample rate ua.in.smartjava.filter settings */
    ...
    public void setSampleRateFrequencyCorrection(int ppm) throws SourceException
    {
        ...
        writeDemodRegister(mDeviceHandle,
            ...
            1);
		/* Test to retune ua.in.smartjava.controller to apply frequency correction */
        try
        {
        ...
        {
            throw new SourceException("couldn't set ua.in.smartjava.sample rate frequency correction", e);
        }
    }
    ...
    public enum Block
    {
        ...
        ROM(4),
        IR(5),
        I2C(6); //I2C ua.in.smartjava.controller
        ...
        /**
         * Returns the value left shifted 8 ua.in.smartjava.bits
         */
    ...
    {
        /* Note: ua.in.smartjava.sample rates below 1.0MHz are subject to aliasing */
        ...
        /**
         * Returns the ua.in.smartjava.sample rate that is equal to the argument or the next
         * higher ua.in.smartjava.sample rate
         *
         * @param sampleRate
         * @return
         */
    ...
    /**
     * Adds a ua.in.smartjava.sample listener.  If the USB transfer processor is not currently running, it will auto-start
     */
    ...
    /**
     * Removes the ua.in.smartjava.sample listener.  If this is the last registered listener, the USB transfer processor will
     * halt ua.in.smartjava.buffer processing
     */
     ...
     * ua.in.smartjava.buffer prior to starting streaming.
     */
    public class RTL2832USBTransferProcessor extends USBTransferProcessor
    {
        /**
         * Manages stream of USB transfer buffers and converts buffers to complex ua.in.smartjava.buffer samples for distribution to
         * any registered listeners.
         *
         * @param deviceName to use when logging information or errors
         * @param deviceHandle to the USB bulk transfer device
         * @param sampleAdapter specific to the tuner's byte ua.in.smartjava.buffer format for converting to floating point I/Q samples
