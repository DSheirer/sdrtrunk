...
public class TunerChannel implements Comparable<TunerChannel>
{
	...
	/**
	 * Indicates if any part of this tuner ua.in.smartjava.channel overlaps the specified range
	 */
    ...
    {
		if( this.equals( otherLock ) )
		{
			return 0;
		}
		else if( mFrequency < otherLock.getFrequency() )
		{
			return -1;
		}
		else
