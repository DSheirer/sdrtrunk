...
import ua.in.smartjava.source.tuner.hackrf.HackRFTunerController.HackRFLNAGain;
import ua.in.smartjava.source.tuner.hackrf.HackRFTunerController.HackRFSampleRate;
import ua.in.smartjava.source.tuner.hackrf.HackRFTunerController.HackRFVGAGain;
import ua.in.smartjava.source.tuner.hackrf.HackRFTunerController.Serial;
            ...
            public void actionPerformed( ActionEvent e )
            {
                ...
                catch ( SourceException|UsbException e2 )
                {
                	JOptionPane.showMessageDialog( HackRFTunerEditor.this, "HackRF Tuner Controller"
            			+ " - couldn't apply the ua.in.smartjava.sample rate setting [" + sampleRate.getLabel() +
            			"] " + e2.getLocalizedMessage() );  
                	
                	mLog.error( "HackRF Tuner Controller - couldn't apply ua.in.smartjava.sample rate setting [" +
