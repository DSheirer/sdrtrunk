...
public class RealWaveSource extends RealSource implements IControllableFileSource, AutoCloseable
{
    ...
    public void start(ScheduledExecutorService executor)
    {
        ...
        {
            mLog.error("Error starting real wave ua.in.smartjava.source", e);
        }
    }
    ...
    public void stop()
    {
        ...
        {
            mLog.error("Error stopping real wave ua.in.smartjava.source", e);
        }
    }
    ...
    /**
     * Changes the value returned from getFrequency() for this ua.in.smartjava.source.
     */
    ...
    /**
     * Closes the ua.in.smartjava.source file
     */
    public void close() throws IOException
    {
        ...
        {
            throw new IOException("Can't close wave ua.in.smartjava.source - was not opened");
        }
    ...
    /**
     * Opens the ua.in.smartjava.source file for reading
     */
    public void open() throws IOException, UnsupportedAudioFileException
    {
        ...
        {
            throw new IOException("Can't open wave ua.in.smartjava.source - is already opened");
        }
        ...
        if(format.getChannels() != 1 || format.getSampleSizeInBits() != 16)
        {
            throw new IOException("Unsupported Wave Format - EXPECTED: 1 " +
                "ua.in.smartjava.channel 16-bit samples FOUND: " +
    ...
    /**
     * Reads the number of frames and sends a ua.in.smartjava.buffer to the listener
     */
    @Override
    ...
    /**
     * Reads the number of frames and optionally sends the ua.in.smartjava.buffer to the listener
     */
    public void next(int frames, boolean broadcast) throws IOException
    {
        if(mInputStream != null)
        {
        	...
        	/* Fill the ua.in.smartjava.buffer with samples from the file */
    ...
    /**
     * Registers the listener to receive ua.in.smartjava.sample buffers as they are read from
     * the wave file
     */
    @Override
    ...
    /**
     * Unregisters the listener from receiving ua.in.smartjava.sample buffers
     */
