...
import ua.in.smartjava.source.mixer.MixerSourceEditor;
import ua.in.smartjava.source.tuner.TunerSourceEditor;
...
public class SourceConfigurationEditor extends Editor<Channel>
{
    ...
    private void setEditor( Editor<Channel> editor )
    {
		...
		{
    		//Set ua.in.smartjava.channel to null to force a save prompt as required
	...
	/**
	 * Sets the ua.in.smartjava.channel configuration.  Note: this method must be invoked from
