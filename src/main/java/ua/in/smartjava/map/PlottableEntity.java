...
public class PlottableEntity implements Comparable<PlottableEntity>
{
	...
	/**
	 * Constructs the entity using the group and ua.in.smartjava.alias from the plottable and
	...
	/**
	 * Gets the ua.in.smartjava.alias for this entity
	 */
	...
	/**
	 * Compares by ua.in.smartjava.alias name
	 */
	@Override
