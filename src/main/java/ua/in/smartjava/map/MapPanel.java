...
public class MapPanel extends JPanel implements PlottableUpdateListener
{
    ...
    private void init()
    {
        ...
        /**
         * Map image ua.in.smartjava.source
         */
        ...
        /**
         * Defines how many threads will be used to fetch the background ua.in.smartjava.map
         * tiles (graphics)
         */
        tileFactory.setThreadPoolSize(8);

        /**
         * Set initial location and zoom for the ua.in.smartjava.map upon display
         */
