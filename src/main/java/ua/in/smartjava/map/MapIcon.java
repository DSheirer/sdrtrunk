...
public class MapIcon extends Setting implements Comparable<MapIcon>
{
	...
	/**
	 * Only ua.in.smartjava.map icons created at runtime can be marked as non-editable, and
	...
	/**
	 * Wrapper class for a ua.in.smartjava.map ua.in.smartjava.icon.
	 * @param name - name of the ua.in.smartjava.icon - also used as key to lookup the ua.in.smartjava.icon
	 * @param path - file path to the ua.in.smartjava.icon
	 * @param editable - defines if the ua.in.smartjava.map ua.in.smartjava.icon or details can be edited
	 * 
	...
	/**
	 * Sort order is determined by the ua.in.smartjava.icon name
	 */
	@Override
