...
public class PlottableEntityRenderer
{
    ...
    public void paintPlottableEntity(Graphics2D g, JXMapViewer viewer, PlottableEntity entity, boolean antiAliasing)
    {
        ...
        /**
         * Paint the route first, so the ua.in.smartjava.icon and label overlay it
         */
        paintRoute(graphics, viewer, entity);

        /**
         * Paint the ua.in.smartjava.icon at the current location
         */
        ...
        /**
         * Paint the label offset to the right of the ua.in.smartjava.icon
         */
