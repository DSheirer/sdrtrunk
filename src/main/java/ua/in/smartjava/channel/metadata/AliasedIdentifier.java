...
public class AliasedIdentifier
{
    ...
    /**
     * Identifier and corresponding optional ua.in.smartjava.alias
     */
    ...
    /**
     * Resets ua.in.smartjava.alias and value to null
     *
    ...
    /**
     * Sets the ua.in.smartjava.alias to the argument
     *
     * Package Private - should only be changed within MutableMetadata
     */
    ...
    /**
     * Indicates if there is an ua.in.smartjava.alias corresponding to the identifier
     */
