...
public class MutableMetadata extends Metadata implements Listener<AttributeChangeRequest>
{
    ...
    /**
     * Mutable ua.in.smartjava.channel metadata.  Contains all attributes that reflect the state and current attribute values for a
     * ua.in.smartjava.channel that is currently decoding.  This metadata is intended to support any decoding ua.in.smartjava.channel ua.in.smartjava.gui components to
     ...
     * immediate monitor in the ua.in.smartjava.audio panel.  When true, this overrides the ua.in.smartjava.audio priority for any ua.in.smartjava.audio produced
     * by the ua.in.smartjava.channel and sets that ua.in.smartjava.audio to the highest priority.
     *
    ...
    /**
     * Adds the listener to receive metadata change events for this ua.in.smartjava.channel metadata
     */
    ...
    /**
     * Removes the listener from receiving metadata change events for this ua.in.smartjava.channel metadata
     */
