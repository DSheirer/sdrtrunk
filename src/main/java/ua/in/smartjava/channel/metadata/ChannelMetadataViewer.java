...
import ua.in.smartjava.channel.details.ChannelDetailPanel;
import com.jidesoft.swing.JideSplitPane;
import com.jidesoft.swing.JideTabbedPane;
import ua.in.smartjava.controller.channel.ChannelProcessingManager;
import ua.in.smartjava.icon.IconManager;
import ua.in.smartjava.module.decode.event.CallEventPanel;
import ua.in.smartjava.module.decode.event.MessageActivityPanel;
import net.miginfocom.swing.MigLayout;
import settings.SettingsManager;
import ua.in.smartjava.spectrum.ChannelSpectrumPanel;
...
public class ChannelMetadataViewer extends JPanel
{
    ...
    /**
     * GUI panel that combines the currently decoding channels metadata table and viewers for ua.in.smartjava.channel details,
