...
public class AttributeMonitor<T>
{
    ...
    /**
     * Alias for the current value.  This class does not return an ua.in.smartjava.alias, but subclasses can return an ua.in.smartjava.alias that
     * is appropriate for the monitored attribute value.
     *
     * @return an optional ua.in.smartjava.alias for the current value
     */
     ...
     *
     * @param illegalValue to prevent for the monitored ua.in.smartjava.alias
     */
