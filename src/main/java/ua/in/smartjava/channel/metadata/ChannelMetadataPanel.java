...
public class ChannelMetadataPanel extends JPanel implements ListSelectionListener
{
    ...
    private static final String PROPERTY_PREFIX_BACKGROUND = "ua.in.smartjava.channel.metadata.panel.state.color.";
    private static final String PROPERTY_PREFIX_FOREGROUND = "ua.in.smartjava.channel.metadata.panel.text.color.";
    ...
    /**
     * Table view for currently decoding ua.in.smartjava.channel metadata
     */
