...
public class Metadata
{
    ...
    /**
     * Channel metadata.  Contains all attributes that reflect the state and current attribute values for a ua.in.smartjava.channel
     * that is currently decoding.  This metadata is intended to support any decoding ua.in.smartjava.channel ua.in.smartjava.gui components to
     * graphically convey the current state of a decoding ua.in.smartjava.channel and to provide ua.in.smartjava.audio metadata
     */
    public Metadata()
    {
    ...
    /**
     * Unique string identifier for this metadata that is comprised of the ua.in.smartjava.channel ID and the primary TO address.
     *
     * This identifier can be used to uniquely identify a ua.in.smartjava.channel ua.in.smartjava.audio stream and the primary communicant.
     */
     ...
     * metadata.  This method is primarily used by downstream ua.in.smartjava.audio playback and ua.in.smartjava.audio recording to signal when changes
    ...
    /**
     * Audio Priority as the highest ua.in.smartjava.audio priority value from across the primary and secondary identifier aliases.
     *
     * A default priority will be used if there are no aliased values.  If there is a conflict between ua.in.smartjava.audio priority
     * and 'Do Not Monitor' among the aliases, the highest ua.in.smartjava.audio priority will be used (prefer to monitor).
     *
     * -1   Do Not Monitor
     ...
     *
     * @return ua.in.smartjava.audio priority
     */
    ...
    /**
     * Indicates if the ua.in.smartjava.audio priority is set to 'Do Not Monitor'
     */
    ...
    /**
     * Indicates that this metadata has been selected by the user and any ua.in.smartjava.audio produced by this ua.in.smartjava.channel will be set
    ...
    /**
     * Unique identifier for the ua.in.smartjava.source ua.in.smartjava.channel that produces this metadata
     */
    ...
    /**
     * Returns the ua.in.smartjava.alias associated with the attribute or null
     */
    ...
    /**
     * Current ua.in.smartjava.channel state
     */
    ...
    /**
     * System name from the ua.in.smartjava.channel configuration
     */
    ...
    /**
     * Indicates if there is a non-null, non-empty ua.in.smartjava.channel configuration system value
     */
    ...
    /**
     * Site name from the ua.in.smartjava.channel configuration
     */
    ...
    /**
     * Indicates if there is a non-null, non-empty ua.in.smartjava.channel configuration site value
     */
    ...
    /**
     * Indicates if there is a non-null, non-empty ua.in.smartjava.channel configuration name value
     */
    ...
    /**
     * Indicates if there is a non-null, non-empty ua.in.smartjava.channel identifier value
     */
    ...
    /**
     * Indicates if there is a non-zero ua.in.smartjava.channel frequency value
     */
    ...
    /**
     * Indicates if there is a non-null, non-empty ua.in.smartjava.message value
     */
    ...
    /**
     * Indicates if there is a non-null, non-empty ua.in.smartjava.message and decoder type value
     */
    ...
    /**
     * Determines the ua.in.smartjava.audio priority from across the primary and secondary TO/FROM aliases when they exist
     */
    private void determineAudioPriority()
    {
        ...
        //If we found a 'Do Not Monitor' and no other ua.in.smartjava.audio priority, then set to do not monitor
     ...
     *
     * The streamable, recordable, ua.in.smartjava.audio priority and broadcast channels are not copied.  These are lazily determined
