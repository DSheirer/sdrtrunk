...
import ua.in.smartjava.module.decode.event.ActivitySummaryProvider;
 ...
 * decoder and broadcasts call events as they occur within the decoded ua.in.smartjava.message activity.
 *
    ...
    IDecoderStateEventProvider, IMessageListener
{
    ...
    /**
     * Reset the decoder state to prepare for processing a different ua.in.smartjava.sample
    ...
    /**
     * Activity Summary - textual summary of activity observed by the ua.in.smartjava.channel state.
     */
