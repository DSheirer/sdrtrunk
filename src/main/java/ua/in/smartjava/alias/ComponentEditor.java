...
public abstract class ComponentEditor<T> extends JPanel implements DocumentListener
{
    ...
    /**
     * Reloads the editor contents from the ua.in.smartjava.source component and resets the
     * modified flag
     */
    public void reset()
    {
     ...
     * saving.  Override this method to allow ua.in.smartjava.controller to pass other editors
