...
public class WildcardID implements Comparable<WildcardID>
{
    ...
    public WildcardID(String value)
    {
        ...
        {
            throw new IllegalArgumentException("Invalid regex pattern for ua.in.smartjava.alias ID value [" + value + "]", e);
        }
    ...
    /**
     * Indicates if the id matches the internal regex pattern for this wildcard ua.in.smartjava.alias ID
     * @param id
     * @return
     */
