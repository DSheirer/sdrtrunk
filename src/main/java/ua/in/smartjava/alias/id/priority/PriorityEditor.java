...
public class PriorityEditor extends DocumentListenerEditor<AliasID>
{
	...
	private static final String HELP_TEXT = "<html>"
			...
			+ "over your computer speakers, or designates an ua.in.smartjava.alias for<br>"
			+ "no-monitoring if you don't want to hear calls from an ua.in.smartjava.alias.<br><br>"
