...
import ua.in.smartjava.alias.AliasEvent.Event;
...
public class AliasModel extends AbstractTableModel
{
    ...
    public AliasList getAliasList(String name)
    {
        ...
        if(name != null)
        {
            ...
            //Register the new ua.in.smartjava.alias list to receive updates from this model
    ...
    /**
     * Returns a list of unique ua.in.smartjava.alias list names from across the ua.in.smartjava.alias set
     */
    ...
    /**
     * Returns a list of ua.in.smartjava.alias group names for all aliases
     */
    ...
    /**
     * Returns a list of ua.in.smartjava.alias group names for all aliases that have a matching
     * list name value
     */
    ...
    /**
     * Adds the ua.in.smartjava.alias to the model
     */
    ...
    /**
     * Removes the ua.in.smartjava.channel from the model and broadcasts a ua.in.smartjava.channel remove event
     */
     ...
     * @param newName to assign to the broadcast ua.in.smartjava.channel
     */
    ...
    public void broadcast(AliasEvent event)
    {
        ...
        //Validate the ua.in.smartjava.alias following a user action that changed the ua.in.smartjava.alias or any ua.in.smartjava.alias IDs
        if(alias != null)
        {
            alias.validate();
        }
