...
import ua.in.smartjava.alias.id.WildcardID;
...
public class AliasList implements Listener<AliasEvent>
{
     ...
     * several methods for ua.in.smartjava.alias lookup from identifier values, like talkgroups.
     *
     * Responds to ua.in.smartjava.alias change events to keep the internal ua.in.smartjava.alias list updated.
     */
    ...
    /**
     * Adds the ua.in.smartjava.alias to this list
     */
    ...
    /**
     * Adds the ua.in.smartjava.alias and ua.in.smartjava.alias identifier to the internal type mapping.
     */
    private void addAliasID(AliasID id, Alias alias)
    {
        if(id.isValid())
        {
            ...
            {
                mLog.error("Couldn't add ua.in.smartjava.alias ID " + id + " for ua.in.smartjava.alias " + alias);
            }
        }
    }

    /**
     * Removes the ua.in.smartjava.alias from this list
     */
    ...
    /**
     * Removes the ua.in.smartjava.alias and ua.in.smartjava.alias identifier from internal mappings.
     */
    ...
    /**
     * Lookup ua.in.smartjava.alias by site ID
     */
    ...
    /**
     * Lookup ua.in.smartjava.alias by status ID
     */
    ...
    /**
     * Lookup ua.in.smartjava.alias by Unique ID (UID)
     */
    ...
    /**
     * Lookup ua.in.smartjava.alias by ESN
     */
    ...
    /**
     * Lookup ua.in.smartjava.alias by fleetsync ID
     */
    ...
    /**
     * Lookup ua.in.smartjava.alias by lojack function and ID
     */
    ...
    /**
     * Lookup ua.in.smartjava.alias by MDC1200 ID
     */
    ...
    /**
     * Lookup ua.in.smartjava.alias by MPT1327 Ident
     */
    ...
    /**
     * Lookup ua.in.smartjava.alias by Mobile ID Number (MIN)
     */
    ...
    /**
     * Lookup ua.in.smartjava.alias by talkgroup
     *
     * @param tgid to use when searching for an ua.in.smartjava.alias
     * @param includeWildcards true if you want to additionally search for a matching ua.in.smartjava.alias that contains wildcard(s)
    ...
    /**
     * Lookup ua.in.smartjava.alias by talkgroup.  Defaults to matching to wildcard talkgroups.
     */
    ...
    /**
     * Indicates if this ua.in.smartjava.alias list has a non-null, non-empty name
     */
    ...
    /**
     * Receive ua.in.smartjava.alias change event notifications and modify this list accordingly
     */
    @Override
