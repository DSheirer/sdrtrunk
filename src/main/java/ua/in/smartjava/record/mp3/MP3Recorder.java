 ...
 *
 ******************************************************************************/
package ua.in.smartjava.record.mp3;
...
/**
 * MP3 recorder for converting 8 kHz PCM ua.in.smartjava.audio packets to MP3 and writing to .mp3 file.
 */
public class MP3Recorder extends AudioRecorder
{
    ...
    /**
     * MP3 ua.in.smartjava.audio recorder ua.in.smartjava.module for converting ua.in.smartjava.audio packets to 16 kHz constant bit rate MP3 format and
     * recording to a file.
     *
    ...
    protected void flush()
    {
        ...
        if(partialFrame != null && partialFrame.length > 0)
        {
            ...
            {
                mLog.error("Error writing final ua.in.smartjava.audio frame data to file", ioe);
            }
        }
    }

    /**
     * Processes ua.in.smartjava.audio metadata contained in the ua.in.smartjava.audio packets and converts the metadata to MP3 ID3 metadata tags and
