...
public class AudioPacketMonoWaveReader extends MonoWaveReader implements Listener<RealBuffer>
{
     ...
     *
     * @param path of file to read containing 8kHz, 16-bit signed litte endian PCM ua.in.smartjava.audio
     * @param realTime causes the read() method to read and dispatch ua.in.smartjava.audio packets in real time.  Note: when using
