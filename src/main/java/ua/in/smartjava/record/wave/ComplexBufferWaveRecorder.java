...
/**
 * WAVE ua.in.smartjava.audio recorder ua.in.smartjava.module for recording complex (I&Q) samples to a wave file
 */
				...
				implements IComplexBufferListener, Listener<ComplexBuffer>
{
    ...
    public void receive( ComplexBuffer buffer )
    {
		if( mRunning.get() )
		{
			...
			if( !success )
			{
				mLog.error( "recorder ua.in.smartjava.buffer overflow - purging [" +
	...
	/**
	 * This is used as a sentinel value to signal the ua.in.smartjava.buffer processor to end
	 */
