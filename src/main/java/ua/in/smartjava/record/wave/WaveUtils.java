...
public class WaveUtils
{
	...
	public static ByteBuffer getWaveHeader( AudioFormat format )
	{
		...
		/* Sample Rate - assumes integral ua.in.smartjava.sample rate */
		...
		/* Byte Rate = ua.in.smartjava.sample rate * channels * ua.in.smartjava.bits per ua.in.smartjava.sample / 8 */
