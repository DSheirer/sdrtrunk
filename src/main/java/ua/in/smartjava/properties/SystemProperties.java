 ...
 *
 ******************************************************************************/
package ua.in.smartjava.properties;
...
/**
 * SystemProperties - provides an isolated instance of ua.in.smartjava.properties for the application
 */
public class SystemProperties
{
    ...
    private static String PROPERTIES_FILENAME = "SDRTrunk.ua.in.smartjava.properties";
    ...
    /**
     * Returns a SINGLETON instance of the application ua.in.smartjava.properties set
     *
     * @return
     */
    ...
    /**
     * Saves any currently changed settings to the application ua.in.smartjava.properties file
     */
    private void save()
    {
    ...
    public void logCurrentSettings()
    {
        ...
        {
            mLog.info("SystemProperties - no ua.in.smartjava.properties file loaded - using defaults");
        }
        else
        {
            mLog.info("SystemProperties - application ua.in.smartjava.properties loaded [" + mPropertiesPath.toString() + "]");
        }
    }

    /**
     * Loads the ua.in.smartjava.properties file into this ua.in.smartjava.properties set
     */
    public void load(Path propertiesPath)
    {
        if(propertiesPath != null)
        {
            ...
            if(Files.exists(mPropertiesPath))
            {
                ...
                {
                    mLog.error("Error loading system ua.in.smartjava.properties file", ioe.getMessage());
                }
            }
        }
    ...
    /**
     * Gets the named color property, storing the default value in ua.in.smartjava.properties file if it doesn't exist.
     *
    ...
    public class SavePropertiesTask implements Runnable
    {
        ...
        public void run()
        {
            if(mSavePending.compareAndSet(true, false))
            {
                ...
                {
                    mLog.error("Error saving system ua.in.smartjava.properties file [" + propsPath.toString() + "]", ioe);
                }
            }
        }
    }
