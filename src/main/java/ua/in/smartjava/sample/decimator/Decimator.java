 ...
 ******************************************************************************/
package ua.in.smartjava.sample.decimator;
...
public class Decimator<T> implements Listener<T>
{
     ...
     * ua.in.smartjava.sample to registered listeners and discards the next decimationFactor - 1
     * samples.
     */
    ...
    /**
     * Receives and broadcasts a ua.in.smartjava.sample and then discards the next
    ...
    /**
     * Adds a ua.in.smartjava.sample listener to receive samples
     */
