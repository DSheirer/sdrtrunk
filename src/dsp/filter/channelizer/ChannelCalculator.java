...
public class ChannelCalculator
{
     ...
     */
    public ChannelCalculator(int sampleRate, int channelCount, double centerFrequency, double oversampling)
    {
    ...
    {
        setChannelCount((int)((double)sampleRate / getChannelBandwidth()));
    }
